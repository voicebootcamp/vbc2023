...
defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	if($user->guest){
		...
		$pdflink = JRoute::_( "index.php?option=com_rsappt_pro3&view=advadmin")."&task=printer&frompage=advadmin".
...
<script>
  jQuery(document).ready(function() {
	...
	var the_tabs = jQuery('#tabs_j4').tabs();
	the_tabs.tabs({ active: <?php echo $current_tab; ?> });
	jQuery('#tabs_j4').bind('tabsselect', function(event, ui) {
  	...
  	<div id="tabs_j4">    
        ...
        <ul class="nav nav-tabs">
          <li class="nav-item active">
            <a class="nav-link active" href="#panel1" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_BOOKING'); ?></a>
          </li>
              ...
              <li class="nav-item" onclick="setTab(0)">
                <a class="nav-link" href="#panel2" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_RESOURCES'); ?></a>
              </li>
              <?php } ?>
              ...
              <li class="nav-item" onclick="setTab(1)">
                <a class="nav-link" href="#panel3" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_SERVICES'); ?></a>
              </li>
              <?php } ?>
              <?php if($apptpro_config->adv_admin_show_timeslots == "Yes" || in_array($apptpro_config->adv_admin_show_timeslots, $my_groups)){?>
              <li class="nav-item" onclick="setTab(2)"><a class="nav-link" href="#panel4" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_TIMESLOTS'); ?></a></li>
              <?php } ?>
              <?php if($apptpro_config->adv_admin_show_bookoffs == "Yes" || in_array($apptpro_config->adv_admin_show_bookoffs, $my_groups)){?>
              <li class="nav-item" onclick="setTab(3)"><a class="nav-link" href="#panel5" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_BOOKOFFS'); ?></a></li>
              <?php } ?>
              <?php if($apptpro_config->adv_admin_show_book_dates == "Yes" || in_array($apptpro_config->adv_admin_show_book_dates, $my_groups)){?>
              <li class="nav-item" onclick="setTab(12)"><a class="nav-link" href="#panel12" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_BOOK_DATES'); ?></a></li>
              <?php } ?>
              <?php if($apptpro_config->adv_admin_show_coupons == "Yes" || in_array($apptpro_config->adv_admin_show_coupons, $my_groups)){?>
              <li class="nav-item" onclick="setTab(7)"><a class="nav-link" href="#panel7" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_COUPONS'); ?></a></li>
              <?php } ?>
              <?php if($apptpro_config->adv_admin_show_extras == "Yes" || in_array($apptpro_config->adv_admin_show_extras, $my_groups)){?>
              <li class="nav-item" onclick="setTab(8)"><a class="nav-link" href="#panel8" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_EXTRAS'); ?></a></li>
              <?php } ?>
              <?php if($apptpro_config->adv_admin_show_rate_adj == "Yes" || in_array($apptpro_config->adv_admin_show_rate_adj, $my_groups)){?>
              <li class="nav-item" onclick="setTab(9)"><a class="nav-link" href="#panel9" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_RATE_ADJ'); ?></a></li>
              <?php } ?>
              <?php if($apptpro_config->adv_admin_show_seat_adj == "Yes" || in_array($apptpro_config->adv_admin_show_seat_adj, $my_groups)){?>
              <li class="nav-item" onclick="setTab(10)"><a class="nav-link" href="#panel10" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_SEAT_ADJ'); ?></a></li>
              <?php } ?>
              <?php if(in_array($apptpro_config->adv_admin_show_credits, $my_groups)){?>
              <li class="nav-item" onclick="setTab(11)"><a class="nav-link" href="#panel11" data-toggle="tab"><?php echo JText::_('RS1_ADMIN_SCRN_TAB_CREDITS'); ?></a></li>
              <?php } ?>
              <?php 
                    $i=20;
                    foreach($pay_procs as $pay_proc){ 
                        ...
                        if($who_to_show == "Yes" || in_array($who_to_show, $my_groups)){
                            ?>
              <li class="nav-item" onclick="setTab(<?php echo $i?>)"><a class="nav-link" href="#panel<?php echo $i?>" data-toggle="tab"><?php echo JText::_($pay_proc->display_name); ?></a></li>
              <?php
                            $i++;	
                        }				
                    }
        ...
        <div id="panel1" class="tab-pane active">
          ...
          <table cellpadding="4" cellspacing="0" border="0" width="100%">
            ...
            $row = $this->items[$i];
            	$link 	= JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=edit&cid='. $row->id_requests.'&frompage=advadmin&tab=0';
        ...
        if($apptpro_config->adv_admin_show_resources == "Yes" || in_array($apptpro_config->adv_admin_show_resources, $my_groups)){
            $tab = $tab + 1;
            $link_new_res = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=res_detail&cid=0&frompage=advadmin&tab='.$tab;
        ?>
          ...
          <table cellpadding="4" cellspacing="0" border="0" class="adminlist" width="100%">
            ...
            $link 	= JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=res_detail&cid='. $res_row->id_resources.'&frompage=advadmin&tab='.$tab;
        ...
        if($apptpro_config->adv_admin_show_services == "Yes" || in_array($apptpro_config->adv_admin_show_services, $my_groups)){
            $tab = $tab + 1;
            $link_new_srv = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=services_detail&cid=0&frompage=advadmin&tab='.$tab;
        ?>
          ...
          <table cellpadding="4" cellspacing="0" border="0" class="adminlist" width="100%">
            ...
            $link = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=services_detail&cid='. $srv_row->id_services.'&frompage=advadmin&tab='.$tab;
           ?>
            <tr class="<?php echo "row$k"; ?>">
        ...
        if($apptpro_config->adv_admin_show_timeslots == "Yes" || in_array($apptpro_config->adv_admin_show_timeslots, $my_groups)){
            ...
            $link_new_ts = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=timeslots_detail&cid=0&frompage=advadmin&tab='.$tab;		
        ?>
          ...
          <table cellpadding="4" cellspacing="0" border="0" class="adminlist" width="100%">
            ...
            <?php
                ...
                $link = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=timeslots_detail&cid='. $ts_row->id_timeslots.'&frompage=advadmin&tab='.$tab;
        ...
        if($apptpro_config->adv_admin_show_bookoffs == "Yes" || in_array($apptpro_config->adv_admin_show_bookoffs, $my_groups)){
            $tab = $tab + 1;
            $link_new_bo = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=bookoffs_detail&cid=0&frompage=advadmin&tab='.$tab;
        ?>
          ...
          <table cellpadding="4" cellspacing="0" border="0" class="adminlist" width="100%">
            ...
            $link = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=bookoffs_detail&cid='. $boff_row->id_bookoffs.'&frompage=advadmin&tab='.$tab;
           ?>
            <tr class="<?php echo "row$k"; ?>">
        ...
        if($apptpro_config->adv_admin_show_coupons == "Yes" || in_array($apptpro_config->adv_admin_show_coupons, $my_groups)){
            ...
            $link_new_coup = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=coupons_detail&cid=0&frompage=advadmin&tab='.$tab;
        ?>
          ...
          <table cellpadding="4" cellspacing="0" border="0" class="adminlist" width="100%">
            ...
            for($i=0; $i < sv_count_($this->items_coup ); $i++) {
                ...
                if($show_row == true){
                    ...
                    $link = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=coupons_detail&cid='. $coup_row->id_coupons.'&frompage=advadmin&tab='.$tab;
        ...
        if($apptpro_config->adv_admin_show_extras == "Yes" || in_array($apptpro_config->adv_admin_show_extras, $my_groups)){
            ...
            $link_new_ext = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=extras_detail&cid=0&frompage=advadmin&tab='.$tab;
        ?>
          ...
          <table cellpadding="4" cellspacing="0" border="0" class="adminlist" width="100%">
            ...
            for($i=0; $i < sv_count_($this->items_ext ); $i++) {
                ...
                if($show_row == true){
                    ...
                    $link = JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail').'&task=extras_detail&cid='. $ext_row->id_extras.'&frompage=advadmin&tab='.$tab;
