 ...
 */
class extras_detailViewextras_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_EXTRAS_DETAIL' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit'  );
		JToolBarHelper::save();
		...
		JToolBarHelper::divider();
		JToolBarHelper::help( 'ABPRO2_HELP_EXTRA_EDIT', true );    
