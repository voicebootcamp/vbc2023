...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('admin_email_body', $this->message->admin_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('user_email_body', $this->message->user_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
	...
	<div class="controls">
		<?php echo $editor->display('user_email_body_offline', $this->message->user_email_body_offline, '100%', '350', '75', '8') ;?>
	</div>
</div>
<?php
foreach ($this->extraOfflinePlugins as $offlinePaymentPlugin)
{
	...
	<div class="control-group">
		...
		<div class="controls">
			<?php echo $editor->display('user_email_body_offline' . $prefix, $this->message->{'user_email_body_offline' . $prefix}, '100%', '350', '75', '8'); ?>
		</div>
	</div>
	<?php
}
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('group_member_email_body', $this->message->group_member_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('registration_approved_email_body', $this->message->registration_approved_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('admin_registration_approved_email_subject', Text::_('EB_ADMIN_REGISTRATION_APPROVED_EMAIL_SUBJECT')); ?>
        <p class="eb-available-tags">
			<?php echo Text::_('EB_AVAILABLE_TAGS'); ?>: <strong>[EVENT_TITLE]</strong>
        </p>
    </div>
    <div class="controls">
        <input type="text" name="admin_registration_approved_email_subject" class="input-xlarge" value="<?php echo $this->message->admin_registration_approved_email_subject; ?>" size="50" />
    </div>
</div>
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('admin_registration_approved_email_body', Text::_('EB_ADMIN_REGISTRATION_APPROVED_EMAIL_BODY')); ?>
        <p class="eb-available-tags">
			<?php echo Text::_('EB_AVAILABLE_TAGS'); ?>: <strong><?php echo $fields; ?></strong>
        </p>
    </div>
    <div class="controls">
		<?php echo $editor->display('admin_registration_approved_email_body', $this->message->admin_registration_approved_email_body, '100%', '350', '75', '8') ;?>
    </div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('certificate_email_body', $this->message->certificate_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('event_cancel_email_body', $this->message->event_cancel_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('send_registrants_list_email_subject', Text::_('EB_SEND_REGISTRANTS_LIST_EMAIL_SUBJECT')); ?>
        <p class="eb-available-tags">
			<?php echo Text::_('EB_AVAILABLE_TAGS'); ?>: <strong>[EVENT_TITLE], [EVENT_DATE]</strong>
        </p>
    </div>
    <div class="controls">
        <input type="text" name="send_registrants_list_email_subject" class="input-xlarge" value="<?php echo $this->message->send_registrants_list_email_subject; ?>" size="80" />
    </div>
</div>
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('send_registrants_list_email_body', Text::_('EB_SEND_REGISTRANTS_LIST_EMAIL_BODY'), Text::_('EB_SEND_REGISTRANTS_LIST_EMAIL_BODY_EXPLAIN')); ?>
        <p class="eb-available-tags">
			<?php echo Text::_('EB_AVAILABLE_TAGS'); ?>: <strong>[EVENT_ID],[EVENT_TITLE],[ALIAS],[PRICE_TEXT],[EVENT_DATE],[EVENT_END_DATE],[EVENT_DATE_DATE],[EVENT_DATE_TIME],[EVENT_END_DATE_DATE],[EVENT_END_DATE_TIME],[CANCEL_BEFORE_DATE],[SHORT_DESCRIPTION],[DESCRIPTION],[EVENT_CAPACITY],[INDIVIDUAL_PRICE],[EVENT_LINK], [TOTAL_REGISTRANTS]</strong>
        </p>
    </div>
    <div class="controls">
		<?php echo $editor->display('send_registrants_list_email_body', $this->message->send_registrants_list_email_body, '100%', '350', '75', '8') ;?>
    </div>
</div>
