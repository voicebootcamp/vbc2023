...
class authnet_transactions_detailController extends JControllerForm
{
	...
	*/
	function edit($key=null, $urlVar=null)
	{
		...
		// Checkin the authnet_transactions
		$model = $this->getModel('authnet_transactions_detail');
		$model->checkout();
	}
	...
	*/
	function save($key=null, $urlVar=null)
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=authnet_transactions',$msg );
	}
	...
	*/
	...
	function view_txn()
	{
		...
		$sql = "SELECT id_authnet_transactions FROM #__sv_apptpro3_authnet_transactions WHERE x_trans_id = '". $jinput->getString('txnid')."'";
		//echo $sql;
