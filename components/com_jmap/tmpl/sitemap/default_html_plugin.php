...
if (count ( $this->source->data )) {
	...
	if(isset($this->source->itemsTree) && isset($this->source->categoriesTree)) {
		...
		echo '<ul class="jmap_filetree plugin-' . strtolower($this->source->name) . '"><li><span class="folder">' . $sourceTitle. '</span>';
		...
		echo '<ul class="jmap_filetree plugin-' . strtolower($this->source->name) . '"><li><span class="folder">' . $sourceTitle. '</span><ul>';
