...
class udfsViewudfs extends JViewLegacy
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - udfs') );
   
   
   		//DEVNOTE: Set ToolBar title
	    JToolBarHelper::title( 'Appointment Booking Pro - '.JText::_( 'RS1_ADMIN_TOOLBAR_UDF' ), 'udf' );
    
    	//DEVNOTE: Set toolbar items for the page
		JToolBarHelper::addNew('add', JText::_('RS1_ADMIN_TOOLBAR_UDF_NEW'));
		JToolBarHelper::editList('edit', JText::_('RS1_ADMIN_TOOLBAR_UDF_EDIT'));
		JToolBarHelper::publishList();
		JToolBarHelper::unpublishList();
		JToolBarHelper::divider();
		JToolBarHelper::deleteList( JText::_('RS1_ADMIN_TOOLBAR_UDF_DEL_CONF'), 'remove', JText::_('RS1_ADMIN_TOOLBAR_UDF_DEL') );
		JToolBarHelper::divider();
		JToolBarHelper::cancel('cancel', 'JTOOLBAR_CLOSE');
		JToolBarHelper::divider();
		JToolBarHelper::help('screen.rsappt_pro.udfs', true);
