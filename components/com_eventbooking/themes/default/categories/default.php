...
<div id="eb-categories-page" class="eb-container">
	<?php
		...
		if (count($this->items))
		{
			...
			{
				echo EventbookingHelperHtml::loadCommonLayout('common/categories.php', array('categories' => $this->items, 'categoryId' => $this->categoryId, 'config' => $this->config, 'params' => $this->params, 'Itemid' => $this->Itemid));
			}
			else
			{
