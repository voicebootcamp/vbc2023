	...
	private function drawSettingForm($row)
	{
        ...
        <div class="control-group">
            <div class="control-label">
				<?php echo EventbookingHelperHtml::getFieldLabel('acymailing_list_ids', Text::_('PLG_EB_ACYM_ASSIGN_TO_LIST_USER'), Text::_('PLG_EB_ACYM_ASSIGN_TO_LIST_USER_EXPLAIN')); ?>
            </div>
            <div class="controls">
