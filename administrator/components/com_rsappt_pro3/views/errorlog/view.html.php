...
class errorlogViewerrorlog extends JViewLegacy
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title( 'Appointment Booking Pro - '.JText::_('RS1_ADMIN_TOOLBAR_ERROR_LOG' ), 'log' );
...
//		JToolBarHelper::divider();
//		JToolBarHelper::help( 'ABPRO2_HELP_ERRORLOG', true );    
	...
	rsappt_pro3Helper::addSubmenu('error_log');
