...
class backup_restoreViewbackup_restore_results extends JViewLegacy
{
	/**
	 * Custom Constructor
	 */
	function __construct( $config = array())
	{
	  ...
	  **/	  
 	 ...
 	 global $context;
	 $context = 'backup_restore.results.';
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - backup_restore') );
