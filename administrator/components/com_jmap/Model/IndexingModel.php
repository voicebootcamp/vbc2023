	...
	public function getData(): array {
		...
		try {
			...
			if($keyword) {
				...
				$rankedPageKeyword = SeostatsServicesGoogle::getRankedPageKeyword($keyword, $siteDomainForKeyword, $this->getState ( 'limitstart', 0 ), 100, $customHeaders);
