...
<?php
	if (!empty($this->item->api_login) && !empty($this->item->transaction_key))
	{
	?>
        <div class="control-group">
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('reply_to_email', Text::_('EB_REPLY_TO_EMAIL'), Text::_('EB_REPLY_TO_EMAIL_EXPLAIN')); ?>
    </div>
    <div class="controls">
        <input type="text" name="reply_to_email" class="form-control" size="70" value="<?php echo $this->item->reply_to_email; ?>" />
    </div>
</div>
<div class="control-group">
	<div class="control-label">
...
?>
	<div class="control-group">
		...
		<div class="controls">
			<?php echo $editor->display('invoice_format', $this->item->invoice_format, '100%', '550', '90', '6');?>
		</div>
	</div>
<?php
}
