...
class rate_adjustments_detailController extends JControllerForm
{
	...
	*/
	function edit($key=null, $urlVar=null)
	{
		...
		// Checkin the rate_adjustments
		$model = $this->getModel('rate_adjustments_detail');
		$model->checkout();
	}
	...
	*/
	function save($key=null, $urlVar=null)
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=rate_adjustments',$msg );
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=rate_adjustments' );
		}
	}
