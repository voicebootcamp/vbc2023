...
DROP TABLE IF EXISTS `#__sv_apptpro3_request_header`;
DROP TABLE IF EXISTS `#__sv_apptpro3_request_detail`;
...
DROP TABLE IF EXISTS `#__sv_apptpro3_2co_transactions`;
...
DROP TABLE IF EXISTS `#__sv_apptpro3_payage_settings`;
DROP TABLE IF EXISTS `#__sv_apptpro3_products`;
DROP TABLE IF EXISTS `#__sv_apptpro3_notification_list`;
DROP TABLE IF EXISTS `#__sv_apptpro3_book_dates`;
DROP TABLE IF EXISTS `#__sv_apptpro3_stripe_settings`;
DROP TABLE IF EXISTS `#__sv_apptpro3_stripe_currency`;
DROP TABLE IF EXISTS `#__sv_apptpro3_stripe_transactions`;
DROP TABLE IF EXISTS `#__sv_apptpro3_export_columns`;
