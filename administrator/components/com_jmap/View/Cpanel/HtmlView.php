	...
	public function display($tpl = null) {
		...
		if($componentParams->get('enable_precaching', 0)) {
			...
			$doc->getWebAssetManager()->addInlineScript("var jmap_removedefaultprefix=" . (int)$removeDefaultPrefix . ";" .
														"var jmap_sh404sefmultilang=" . (int)$componentParams->get('sh404sef_multilang', 0) . ";" .
		...
		if($componentParams->get('geositemap_enabled', 0) && $componentParams->get('geositemap_address', null)) {
			$doc->getWebAssetManager()->registerAndUseScript ('jmap.mapsapi', 'https://maps.google.com/maps/api/js?key=AIzaSyDNlp3wN1Al_ksW92rmb5Y96RQGn68tKb8');
			$doc->getWebAssetManager()->registerAndUseScript ('jmap.gmap', 'administrator/components/com_jmap/js/gmap.js', [], [], ['jquery', 'jmap.mapsapi'] );
			$doc->getWebAssetManager()->addInlineScript("var jmap_geositemapAddress='" . addslashes($componentParams->get('geositemap_address', '')) . "';");
		}
