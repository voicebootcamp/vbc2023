...
class _2co_transactionsModel_2co_transactions extends JModelLegacy
{
	...
	/**
	 * Method to get a _2co_transactions data
	 *
	 * this method is called from the owner VIEW by VIEW->get('Data');
	 * - get list of all _2co_transactions for the current data page.
	...
	/**
	 * Method to get the total number of _2co_transactions items
	 *
	 * @access public
	 * @return integer
	 */
	...
	/**
	 * Method to get a pagination object for the _2co_transactions
	 */
	...
	function _buildQuery()
	{
		...
		$query = ' SELECT * FROM '.$this->_table_prefix.'_2co_transactions'.$orderby;
		//echo $query;
		//exit;
