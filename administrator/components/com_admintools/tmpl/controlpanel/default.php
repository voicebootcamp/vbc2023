			...
			<div class="row align-items-start">
				<div class="col-lg-6">
					<div class="mb-3">
						...
						<div>
							<?= Text::sprintf('COM_ADMINTOOLS_CONTROLPANEL_LBL_RELEASED_ON', HTMLHelper::_('admintools.formatDate', new Date(defined('ADMINTOOLS_DATE') ? ADMINTOOLS_DATE : gmdate('Y-m-d')), false, Text::_('DATE_FORMAT_LC3'))) ?>
						</div>
					</div>
