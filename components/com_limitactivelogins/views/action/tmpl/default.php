...
<div id="limitactivelogins" class="w357kit-margin">
	...
	<div class="w357kit-alert-danger" w357kit-alert>
		<h4><?php echo Text::_('Login failed!'); ?></h4>
		<div><?php echo $this->custom_error_message; ?></div>
	</div>

	<?php if ($this->show_logged_in_devices): ?>
		...
		<form action="<?php echo htmlspecialchars(Uri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
			...
			<div class="w357kit-child-width-1-1 w357kit-grid-divider" w357kit-grid>
				...
				foreach ($this->logged_in_devices as $item) : 
