...
// Get resources for list
	...
	try{
		...
		logIt($e->getMessage(), "be_coup_copy_tmpl_default", "", "");
...
<link href="<?php echo JURI::root( true );?>/components/com_rsappt_pro3/sv_apptpro.css" rel="stylesheet">
  <table border="0" cellpadding="4" cellspacing="4" width="100%">
    <tr>
      <td>
      <?php echo JText::_('RS1_ADMIN_SCRN_COUPONS_COPY');?></td>
    </tr>
    <tr>
      <td width="322" ><?php echo JText::_('RS1_ADMIN_SCRN_COUPONS_COPY_NUMBER');?>
      <input type="number" style="width:30px; text-align: center" name="number_of_copies" size="4" value="1" /></td>
    </tr>
        <tr>
          <td><?php echo JText::_('RS1_ADMIN_SCRN_COUPONS_COPY_NEW_DATE_HELP');?><br /><?php echo JText::_('RS1_ADMIN_SCRN_COUPONS_COPY_NEW_DATE');?>:
          <input class="sv_date_box" type="text" size="12" maxsize="10" readonly="readonly" name="new_coupon_date" id="new_coupon_date" value="" />
		        <a href="#" id="anchor1" onclick="cal.select(document.forms['adminForm'].new_coupon_date,'anchor1','yyyy-MM-dd'); return false;"
  ...
  <input type="hidden" name="coupons_tocopy" value="<?php echo $this->coupons_tocopy; ?>" />
