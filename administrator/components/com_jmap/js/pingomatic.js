	...
	var PingomaticClient = function (formElem, configOptions) {
		...
		function openPingomaticProgress() {
			...
			var firstProgress = '<div class="progress">' +
									'<div id="progressBar1" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100">' +
		...
		function openModelProgress() {
			...
			var secondProgress = '<div class="progress">' +
									'<div id="progressBar2" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100">' +
