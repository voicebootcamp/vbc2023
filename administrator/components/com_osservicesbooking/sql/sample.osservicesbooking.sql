...
INSERT INTO `#__app_sch_services` (`id`, `category_id`, `service_name`, `service_price`, `service_length`, `service_before`, `service_after`, `service_total`, `service_description`, `service_photo`, `service_time_type`, `step_in_minutes`, `repeat_day`, `repeat_week`, `repeat_month`, `ordering`, `published`, `access`, `max_seats`, `early_bird_amount`,`early_bird_days`,`discount_amount`) VALUES (2, 1, 'Tennis court', 75.00, 60, 10, 10, 80, 'A tennis court is where the game of tennis is played. It is a firm rectangular surface with a low net stretched across the center. The same surface can be used to play both doubles and singles.\r\nlay courts are made of crushed shale, stone, or brick. The French Open is the only Grand Slam tournament to use clay courts.', 'tennis.jpg', 1, 1, 1, 1,0, 1, 1,1, 0, 0, 0, 0),
(3, 3, 'Massage', 12.69, 59, 0, 0, 59, 'Massage is the manipulating of superficial and deeper layers of muscle and connective tissue using various techniques, to enhance function, aid in the healing process, and promote relaxation and well-being.', 'massage.jpg', 0, 1, 1, 1,0, 2, 1,1, 0, 0, 0, 0),
(5, 1, 'Beauty salon', 12.34, 90, 5, 5, 100, 'A beauty salon or beauty parlor (International spelling: beauty parlour) (or sometimes beauty shop) is an establishment dealing with cosmetic treatments for men and women.[1] Other variations of this type of business include hair salons and spas.', 'baby.jpg',  0, 1, 1, 1,0, 3, 1,1, 0, 0, 0, 0);
...
INSERT INTO `#__app_sch_venues` (`id`, `image`, `address`, `city`, `state`, `country`, `lat_add`, `long_add`, `contact_email`, `contact_name`, `contact_phone`, `disable_booking_before`, `number_date_before`, `disable_date_before`, `disable_booking_after`, `number_date_after`, `disable_date_after`, `published`,`number_hour_before`) VALUES
(1, '', '152 Smith St, 11201', 'New York', 'New York', 'United States', '40.6865256', '-73.9907369', '', 'Dang Thuc Dam', '34234324', 1, 5, '2013-04-03', 2, 5, '0000-00-00', 1,0);
