...
if ($bootstrapHelper->getFrameworkClass('uk-input')) // UIKIT
{
	$inputClass  = "uk-input";
	$selectClass = "uk-select";
}
elseif ($bootstrapHelper->getFrameworkClass('form-select')) // Bootstrap 5
{
...
if ($enableRadiusSearch)
{
	...
	$lists['filter_distance'] = HTMLHelper::_('select.genericlist', $options, 'filter_distance', ' class="' . $selectClass . '" ', 'value', 'text', $filterDistance);
}
