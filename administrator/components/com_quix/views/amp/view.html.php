 ...
 * @since  1.6
 */
class QuixViewAmp extends JViewLegacy
{
    protected $state;
    ...
    {
        JToolBarHelper::title(JText::_('COM_QUIX_TITLE_AMP'), 'home');
        ...
        if ($canDo->get('core.edit.state')) {
            ...
            $bar->appendButton('Custom', $layout->render([]), 'schema');
        ...
        JHtmlSidebar::setAction('index.php?option=com_quix&view=amp');
    }
}
