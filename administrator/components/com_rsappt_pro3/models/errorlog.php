...
class errorlogModelerrorlog extends JModelLegacy
{
	...
	/**
	 * Method to get a errorlog data
	 *
	 * this method is called from the owner VIEW by VIEW->get('Data');
	 * - get list of all errorlog for the current data page.
	...
	/**
	 * Method to get the total number of errorlog items
	 *
	 * @access public
	 * @return integer
	 */
	...
	/**
	 * Method to get a pagination object for the errorlog
	 */
	...
	function _buildQuery()
	{
		...
		$query = ' SELECT * FROM '.$this->_table_prefix.'errorlog'.$orderby;
		//echo $query;
		//exit;
