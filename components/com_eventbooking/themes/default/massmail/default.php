...
<form action="<?php echo Route::_('index.php?option=com_eventbooking&view=massmail&Itemid=' . $this->Itemid); ?>" method="post" name="adminForm" id="adminForm" class="form form-horizontal" enctype="multipart/form-data">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="email" name="reply_to_email" value="" size="70" class="form-control input-xlarge" />
        </div>
    </div>
	<div class="control-group">
		<div class="control-label">
	...
	<div class="control-group">
		...
		<div class="controls">
			<?php echo $editor->display('description', $message->mass_mail_template, '100%', '350', '75', '10') ; ?>
		</div>
	</div>
