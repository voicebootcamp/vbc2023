...
<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
	<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
		<fieldset class="form-horizontal options-form">
            ...
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('activate_simple_tax', Text::_('EB_ACTIVATE_SIMPLE_TAX'), Text::_('EB_ACTIVATE_SIMPLE_TAX_EXPLAIN')); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('activate_simple_tax', $config->activate_simple_tax); ?>
                </div>
            </div>
			<div class="control-group">
				<div class="control-label">
        ...
        <fieldset class="form-horizontal options-form" style="margin-top:3px;">
            <legend><?php echo Text::_('EB_DATETIME_FORMAT'); ?></legend>
            <div class="control-group">
                <div class="control-label">
        ...
        <fieldset class="form-horizontal options-form" style="margin-top:3px;">
            <legend><?php echo Text::_('EB_FRONTEND_MANAGEMENT'); ?></legend>
            <div class="control-group">
                <div class="control-label">
	        ...
	        <div class="control-group">
		        <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('use_media_manager', Text::_('EB_USE_MEDIA_MANAGER'), Text::_('EB_USE_MEDIA_MANAGER_EXPLAIN')); ?>
		        </div>
		        <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('use_media_manager', $config->use_media_manager); ?>
		        </div>
	        </div>
            <div class="control-group">
                <div class="control-label">
            ...
            <div class="control-group">
                <div class="control-label">
			        <?php echo EventbookingHelperHtml::getFieldLabel('submit_event_toolbar', Text::_('EB_SUBMIT_EVENT_TOOLBAR')); ?>
                </div>
                <div class="controls">
			        <?php echo $this->lists['submit_event_toolbar']; ?>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
        ...
        <fieldset class="form-horizontal options-form" style="margin-top:3px;">
            <legend><?php echo Text::_('EB_CATEGORIES_EVENTS_DROPDOWN'); ?></legend>
            <div class="control-group">
                <div class="control-label">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="number" name="map_width" class="form-control" value="<?php echo $config->map_width ; ?>" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
				...
				<div class="controls">
					<input type="number" name="map_height" class="form-control" value="<?php echo $config->map_height ; ?>" />
				</div>
			</div>
		<fieldset>
	</div>
	<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
		<fieldset class="form-horizontal options-form">
            ...
            <div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(array('activate_deposit_feature' => '1')); ?>'>
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('enable_full_payment', Text::_('EB_ENABLE_FULL_PAYMENT'), Text::_('EB_ENABLE_FULL_PAYMENT_EXPLAIN')); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('enable_full_payment', $config->get('enable_full_payment', 1)); ?>
                </div>
            </div>
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(array('activate_deposit_feature' => '1')); ?>'>
				<div class="control-label">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('hide_event_when_full', Text::_('EB_HIDE_EVENT_WHEN_FULL'), Text::_('EB_HIDE_EVENT_WHEN_FULL_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('hide_event_when_full', $config->hide_event_when_full); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
            ...
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('enable_ics_export', Text::_('EB_ENABLE_ICS_EXPORT'), Text::_('EB_ENABLE_ICS_EXPORT_EXPLAIN')); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('enable_ics_export', $config->enable_ics_export); ?>
                </div>
            </div>
            <div class="control-group" <div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(array('enable_ics_export' => '1')); ?>'>
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('ics_export_limit', Text::_('EB_ICS_EXPORT_LIMIT'), Text::_('EB_ICS_EXPORT_LIMIT_EXPLAIN')); ?>
                </div>
                <div class="controls">
                    <input type="number" name="ics_export_limit" min="0" value="<?php echo $config->get('ics_export_limit', 100); ?>" class="form-control input-small" />
                </div>
            </div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('allow_filter_registrants_by_type', Text::_('EB_ALLOW_FILTER_REGISTRANTS_BY_TYPE'), Text::_('EB_ALLOW_FILTER_REGISTRANTS_BY_TYPE_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('allow_filter_registrants_by_type', $config->get('allow_filter_registrants_by_type', 0)); ?>
				</div>
			</div>
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('allow_filter_registrants_by_category', Text::_('EB_ALLOW_FILTER_REGISTRANTS_BY_CATEGORY')); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('allow_filter_registrants_by_category', $config->get('allow_filter_registrants_by_category', 1)); ?>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(array('accept_term' => '1')); ?>'>
				...
				<div class="controls">
					<?php echo EventbookingHelperHtml::getArticleInput($config->article_id); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
            ...
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('form_layout', Text::_('EB_FORM_LAYOUT')); ?>
                </div>
                <div class="controls">
					<?php echo $this->lists['form_layout']; ?>
                </div>
            </div>
			<div class="control-group">
				<div class="control-label">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="number" name="category_thumb_width" class="form-control" value="<?php echo $config->category_thumb_width ; ?>" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
				...
				<div class="controls">
					<input type="number" name="category_thumb_height" class="form-control" value="<?php echo $config->category_thumb_height ; ?>" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
				...
				<div class="controls">
					<input type="number" name="thumb_width" class="form-control" value="<?php echo $config->thumb_width ; ?>" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
				...
				<div class="controls">
					<input type="number" name="thumb_height" class="form-control" value="<?php echo $config->thumb_height ; ?>" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(array('resize_event_large_image' => '1')); ?>'>
				...
				<div class="controls">
					<input type="number" name="large_image_width" class="form-control" value="<?php echo $config->large_image_width ; ?>" />
				</div>
			</div>
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(array('resize_event_large_image' => '1')); ?>'>
				<div class="control-label">
				...
				<div class="controls">
					<input type="number" name="large_image_height" class="form-control" value="<?php echo $config->large_image_height ; ?>" />
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="number" name="image_max_file_size" class="form-control input-small d-inline-block" value="<?php echo $config->image_max_file_size ; ?>" /> MB
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
				...
				<div class="controls">
					<input type="number" name="image_max_width" class="form-control input-small d-inline-block" value="<?php echo $config->image_max_width ; ?>" /> px
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
				...
				<div class="controls">
					<input type="number" name="image_max_height" class="form-control input-small d-inline-block" value="<?php echo $config->image_max_height ; ?>" /> px
				</div>
			</div>
		</fieldset>
		<fieldset class="form-horizontal options-form">
			<legend><?php echo Text::_('EB_ANTI_SPAM_SETTINGS'); ?></legend>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('honeypot_fieldname', Text::_('EB_HONEYPOT_FIELD_NAME'), Text::_('EB_HONEYPOT_FIELD_NAME_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<input type="text" name="honeypot_fieldname" class="form-control" value="<?php echo $config->get('honeypot_fieldname', 'eb_my_own_website_name'); ?>" size="10" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('honeypot_field_css_class', Text::_('EB_HONEYPOT_FIELD_CSS_CLASS'), Text::_('EB_HONEYPOT_FIELD_CSS_CLASS_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<input type="text" name="honeypot_field_css_class" class="form-control" value="<?php echo $config->get('honeypot_field_css_class', 'eb-invisible-to-visitors'); ?>" size="10" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('minimum_form_time', Text::_('EB_MINIMUM_FORM_TIME'), Text::_('EB_MINIMUM_FORM_TIME_EXPLAIN')); ?>
				</div>
				<div class="controls">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('maximum_submits_per_session', Text::_('EB_MAXIMUM_SUBMIT_PER_SESSIONS'), Text::_('EB_MAXIMUM_SUBMIT_PER_SESSIONS_EXPLAIN')); ?>
				</div>
				<div class="controls">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="number" name="upload_max_file_size" class="form-control input-small d-inline-block" value="<?php $config->get('upload_max_file_size'); ?>" size="60" /> MB
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="number" name="exchange_rate" class="form-control" value="<?php echo $config->get('exchange_rate', ''); ?>" size="10" />
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('open_exchange_rates_app_id', Text::_('EB_OPEN_EXCHANGE_RATE_APP_ID')); ?>
                </div>
                <div class="controls">
                    ...
                    <p class="info" style="margin-top: 10px;">
	                    <?php echo Text::_('EB_OPEN_EXCHANGE_RATE_APP_ID_EXPLAIN'); ?>
                    </p>
                </div>
            </div>
			<div class="control-group">
            ...
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('use_sef_url_for_ajax', Text::_('EB_USE_SEF_URL_FOR_AJAX'), Text::_('EB_USE_SEF_URL_FOR_AJAX_EXPLAIN')); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('use_sef_url_for_ajax', $config->use_sef_url_for_ajax); ?>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('load_legacy_js', Text::_('EB_LOAD_LEGACY_JS'), Text::_('EB_LOAD_LEGACY_JS_EXPLAIN')); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('load_legacy_js', $config->load_legacy_js); ?>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('activate_simple_multilingual', Text::_('EB_ACTIVATE_SIMPLE_MULTILINGUAL'), Text::_('EB_ACTIVATE_SIMPLE_MULTILINGUAL_EXPLAIN')); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('activate_simple_multilingual', $config->activate_simple_multilingual); ?>
                </div>
            </div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('show_update_available_message_in_dashboard', Text::_('EB_SHOW_UPDATE_AVAILABLE'), Text::_('EB_SHOW_UPDATE_AVAILABLE_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('show_update_available_message_in_dashboard', $config->get('show_update_available_message_in_dashboard', 1)); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
