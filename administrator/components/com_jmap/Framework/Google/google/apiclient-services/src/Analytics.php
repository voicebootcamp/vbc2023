...
class Analytics extends \Google\Service {
	...
	public function __construct($clientOrConfig = [ ], $rootUrl = null) {
		...
		$this->data_ga = new Analytics\Resource\DataGa ( $this, $this->serviceName, 'ga', [ 
				'methods' => [ 
						'get' => [ 
								'path' => 'data/ga',
								'httpMethod' => 'GET',
		...
		$this->data_mcf = new Analytics\Resource\DataMcf ( $this, $this->serviceName, 'mcf', [ 
				'methods' => [ 
						'get' => [ 
								'path' => 'data/mcf',
								'httpMethod' => 'GET',
		...
		$this->data_realtime = new Analytics\Resource\DataRealtime ( $this, $this->serviceName, 'realtime', [ 
				'methods' => [ 
						'get' => [ 
								'path' => 'data/realtime',
								'httpMethod' => 'GET',
		...
		$this->management_accountSummaries = new Analytics\Resource\ManagementAccountSummaries ( $this, $this->serviceName, 'accountSummaries', [ 
				'methods' => [ 
						'list' => [ 
		...
		$this->management_accountUserLinks = new Analytics\Resource\ManagementAccountUserLinks ( $this, $this->serviceName, 'accountUserLinks', [ 
				'methods' => [ 
						'delete' => [ 
		...
		$this->management_accounts = new Analytics\Resource\ManagementAccounts ( $this, $this->serviceName, 'accounts', [ 
				'methods' => [ 
						'list' => [ 
		...
		$this->management_clientId = new Analytics\Resource\ManagementClientId ( $this, $this->serviceName, 'clientId', [ 
				'methods' => [ 
						'hashClientId' => [ 
		...
		$this->management_customDataSources = new Analytics\Resource\ManagementCustomDataSources ( $this, $this->serviceName, 'customDataSources', [ 
				'methods' => [ 
						'list' => [ 
		...
		$this->management_customDimensions = new Analytics\Resource\ManagementCustomDimensions ( $this, $this->serviceName, 'customDimensions', [ 
				'methods' => [ 
						'get' => [ 
		...
		$this->management_customMetrics = new Analytics\Resource\ManagementCustomMetrics ( $this, $this->serviceName, 'customMetrics', [ 
				'methods' => [ 
						'get' => [ 
		...
		$this->management_experiments = new Analytics\Resource\ManagementExperiments ( $this, $this->serviceName, 'experiments', [ 
				'methods' => [ 
						'delete' => [ 
		...
		$this->management_filters = new Analytics\Resource\ManagementFilters ( $this, $this->serviceName, 'filters', [ 
				'methods' => [ 
						'delete' => [ 
		...
		$this->management_goals = new Analytics\Resource\ManagementGoals ( $this, $this->serviceName, 'goals', [ 
				'methods' => [ 
						'get' => [ 
		...
		$this->management_profileFilterLinks = new Analytics\Resource\ManagementProfileFilterLinks ( $this, $this->serviceName, 'profileFilterLinks', [ 
				'methods' => [ 
						'delete' => [ 
		...
		$this->management_profileUserLinks = new Analytics\Resource\ManagementProfileUserLinks ( $this, $this->serviceName, 'profileUserLinks', [ 
				'methods' => [ 
						'delete' => [ 
		...
		$this->management_profiles = new Analytics\Resource\ManagementProfiles ( $this, $this->serviceName, 'profiles', [ 
				'methods' => [ 
						'delete' => [ 
		...
		$this->management_remarketingAudience = new Analytics\Resource\ManagementRemarketingAudience ( $this, $this->serviceName, 'remarketingAudience', [ 
				'methods' => [ 
						'delete' => [ 
		...
		$this->management_segments = new Analytics\Resource\ManagementSegments ( $this, $this->serviceName, 'segments', [ 
				'methods' => [ 
						'list' => [ 
		...
		$this->management_unsampledReports = new Analytics\Resource\ManagementUnsampledReports ( $this, $this->serviceName, 'unsampledReports', [ 
				'methods' => [ 
						'delete' => [ 
		...
		$this->management_uploads = new Analytics\Resource\ManagementUploads ( $this, $this->serviceName, 'uploads', [ 
				'methods' => [ 
						'deleteUploadData' => [ 
		...
		$this->management_webPropertyAdWordsLinks = new Analytics\Resource\ManagementWebPropertyAdWordsLinks ( $this, $this->serviceName, 'webPropertyAdWordsLinks', [ 
				'methods' => [ 
						'delete' => [ 
		...
		$this->management_webproperties = new Analytics\Resource\ManagementWebproperties ( $this, $this->serviceName, 'webproperties', [ 
				'methods' => [ 
						'get' => [ 
		...
		$this->management_webpropertyUserLinks = new Analytics\Resource\ManagementWebpropertyUserLinks ( $this, $this->serviceName, 'webpropertyUserLinks', [ 
				'methods' => [ 
						'delete' => [ 
		...
		$this->metadata_columns = new Analytics\Resource\MetadataColumns ( $this, $this->serviceName, 'columns', [ 
				'methods' => [ 
						'list' => [ 
		...
		$this->provisioning = new Analytics\Resource\Provisioning ( $this, $this->serviceName, 'provisioning', [ 
				'methods' => [ 
						'createAccountTicket' => [ 
		...
		$this->userDeletion_userDeletionRequest = new Analytics\Resource\UserDeletionUserDeletionRequest ( $this, $this->serviceName, 'userDeletionRequest', [ 
				'methods' => [ 
						'upsert' => [ 
