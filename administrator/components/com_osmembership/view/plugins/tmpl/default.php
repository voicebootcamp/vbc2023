...
if ($saveOrder)
{
    ...
    {
	    HTMLHelper::_('sortablelist.sortable', 'pluginList', 'adminForm', strtolower($this->state->filter_order_Dir), $saveOrderingUrl);
    }
}
...
Factory::getDocument()->addScript(Uri::root(true) . '/media/com_osmembership/js/admin-plugins-default.min.js');
		...
		<table class="adminlist table table-striped" id="pluginList">
			<thead>
				<tr>
					...
					<th class="title">
						<?php echo HTMLHelper::_('searchtools.sort', Text::_('OSM_NAME'), 'tbl.name', $this->state->filter_order_Dir, $this->state->filter_order); ?>
					</th>
					...
					<th class="title">
						<?php echo HTMLHelper::_('searchtools.sort', Text::_('OSM_AUTHOR'), 'tbl.author', $this->state->filter_order_Dir, $this->state->filter_order); ?>
					</th>
					<th class="title center">
						<?php echo HTMLHelper::_('searchtools.sort', Text::_('OSM_AUTHOR_EMAIL'), 'tbl.email', $this->state->filter_order_Dir, $this->state->filter_order); ?>
					</th>
					<th class="title center">
						<?php echo HTMLHelper::_('searchtools.sort', Text::_('OSM_RECURRING_SUPPORT'), 'tbl.support_recurring_subscription', $this->state->filter_order_Dir, $this->state->filter_order); ?>
					</th>
					<th class="title center">
			...
			{
				$row       = $this->items[$i];
				$link      = Route::_('index.php?option=com_osmembership&view=plugin&id=' . $row->id);
