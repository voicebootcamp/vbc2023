...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('deposit_payment_form_message', $this->message->deposit_payment_form_message, '100%', '350', '75', '8') ;?>
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('deposit_payment_thanks_message', $this->message->deposit_payment_thanks_message, '100%', '350', '75', '8') ;?>
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('deposit_payment_admin_email_body', $this->message->deposit_payment_admin_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('deposit_payment_user_email_body', $this->message->deposit_payment_user_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('deposit_payment_reminder_email_body', $this->message->deposit_payment_reminder_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
