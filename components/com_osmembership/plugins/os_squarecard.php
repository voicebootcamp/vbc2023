...
class os_squarecard extends MPFPayment
{
	/**
	...
	public function __construct($params, $config = [])
	{
		...
		else
		{
			...
			$keys = ['application_id', 'access_token', 'location_id'];
		...
		$document->addScriptOptions('squareAppId', $params->get('application_id'))
			...
			->addScript(Uri::root(true) . '/components/com_osmembership/plugins/squarecard/js/squarecard.js');
	...
	{
		require_once JPATH_ROOT . '/components/com_osmembership/plugins/squarecard/square/vendor/autoload.php';
