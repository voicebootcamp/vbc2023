...
*/
class Tableauthnet_aim_transactions_detail extends JTable
{
	protected $_supportNullValue = true; 
	
	var $id_authnet_aim_transactions = null;
	...
	function __construct($db) {
	  ...
	  $this->_table_prefix = '#__sv_apptpro3_';
		...
		parent::__construct($this->_table_prefix.'authnet_aim_transactions', 'id_authnet_aim_transactions', $db);
	}
...
//		$query = 'SELECT id FROM '.$this->_table_prefix.'authnet_aim_transactions  WHERE name = "'.$this->name;
