 ...
 */
class admin_detailViewpaypal_transactions_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		require_once(JPATH_COMPONENT.DIRECTORY_SEPARATOR.'models'.DIRECTORY_SEPARATOR.'paypal_transactions_detail.php');
		$model = new admin_detailModelpaypal_transactions_detail;
		...
		$isNew		= ($detail->id_paypal_transactions < 1);
