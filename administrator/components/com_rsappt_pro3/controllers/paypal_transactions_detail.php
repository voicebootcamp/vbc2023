...
class paypal_transactions_detailController extends JControllerForm
{
	...
	*/
	function edit($key=null, $urlVar=null)
	{
		...
		// Checkin the paypal_transactions
		$model = $this->getModel('paypal_transactions_detail');
		$model->checkout();
	}
	...
	*/
	function save($key=null, $urlVar=null)
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=paypal_transactions',$msg );
	}
	...
	*/
	...
	function view_txn()
	{
		...
		$sql = "SELECT id_paypal_transactions FROM #__sv_apptpro3_paypal_transactions WHERE txnid = '". $jinput->getString('txnid')."'";
		//echo $sql;
