...
class seat_typesModelseat_types extends JModelLegacy
{
	...
	/**
	 * Method to get a seat_types data
	 *
	 * this method is called from the owner VIEW by VIEW->get('Data');
	 * - get list of all seat_types for the current data page.
	...
	/**
	 * Method to get the total number of seat_types items
	 *
	 * @access public
	 * @return integer
	 */
	...
	/**
	 * Method to get a pagination object for the seat_types
	 */
	...
	function _buildQuery()
	{
		...
		$query = ' SELECT * FROM '.$this->_table_prefix.'seat_types'.$orderby;
		//echo $query;
		//exit;
