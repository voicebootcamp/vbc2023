...
if (!$app->isClient('site'))
{
	...
	JLoader::register('EventbookingHelperLegacy', JPATH_ROOT . '/components/com_eventbooking/helper/legacy.php');
	JLoader::register('EventbookingHelperEmailtags', JPATH_ROOT . '/components/com_eventbooking/helper/emailtags.php');
	...
	$possibleOverrides = [
		...
		'EventbookingHelperOverrideCertificate'  => 'certificate.php',
	];
