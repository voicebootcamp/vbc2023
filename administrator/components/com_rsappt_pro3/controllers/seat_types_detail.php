...
class seat_types_detailController extends JControllerForm
{
	...
	*/
	function edit($key=null, $urlVar=null)
	{
		...
		$jinput->set( 'view', 'seat_types_detail' );
		...
		// Checkin the seat_types
		$model = $this->getModel('seat_types_detail');
		$model->checkout();
	}
	...
	*/
	function save($key=null, $urlVar=null)
	{
		...
		$model->checkin();
		if($key=="2new"){
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=seat_types_detail&task=edit&cid[]=-1',$msg );
		} else {
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=seat_types',$msg );
		}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=seat_types' );
		}
	}
	...
	*/
	...
	/** function saveorder
	*
	* saveorder of the seat_types items
	* 			
	* @param array cid		- array of id
