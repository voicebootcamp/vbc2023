...
<div id="eb-upcoming-events-page-timeline" class="eb-container">
    ...
    <form method="post" name="adminForm" id="adminForm" action="<?php echo Route::_('index.php?option=com_eventbooking&view=upcomingevents&layout=timeline&Itemid=' . $this->Itemid); ?>">
