...
class EventbookingViewConfigurationHtml extends RADViewHtml
{
	public function display()
	{
		...
		$lists['submit_event_toolbar'] = HTMLHelper::_('select.genericlist', $options, 'submit_event_toolbar', 'class="form-select"', 'value', 'text', $config->get('submit_event_toolbar', 'top'));
		...
		$lists['public_registrants_list_show_number_registrants'] = HTMLHelper::_('select.genericlist', $options, 'public_registrants_list_show_number_registrants', 'class="chosen form-select"', 'value', 'text', $config->get('public_registrants_list_show_number_registrants', ''));
		...
		$lists['form_layout'] = HTMLHelper::_('select.genericlist', $options, 'form_layout', 'class="form-select"', 'value', 'text', $config->get('form_layout', 'horizontal'));
