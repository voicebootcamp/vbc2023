...
class JPaneTabs extends JPane
{
	...
	protected function _loadBehavior($params = array())
	{
		...
		{
			$document->addScript(JUri::root(true).'/media/com_osservicesbooking/assets/js/mootools-core.js');
			$document->addScript(JUri::root(true).'/media/com_osservicesbooking/assets/js/mootools-more.js');
		}
