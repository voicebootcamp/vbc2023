	  ...
	  <table class="table table-striped" width="100%" >
        ...
        <tr>
            <td>
                ...
                <?php
                $k = 0;
                for($i=0; $i < sv_count_($this->items_an_aim ); $i++) {
               ...
               ?>
                <tr class="<?php echo "row$k"; ?>">
                  ...
                  <?php if(strpos($an_row->x_invoice_num, "cart|") === false ){?>
                    <!--<td align="center"><?php echo $an_row->x_invoice_num; ?>&nbsp;</td>-->
                  <?php } else {?>
                    <!--<td align="center"><?php echo "cart"; ?></td>-->
                  <?php } ?>  
                  <!--<td align="left"><?php echo stripslashes($an_row->x_last_name.", ".$an_row->x_first_name); ?>&nbsp;</td>-->
