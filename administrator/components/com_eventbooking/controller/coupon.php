...
class EventbookingControllerCoupon extends EventbookingController
{
	...
	public function export()
	{
		...
		$headers = [];
		$results = $this->app->triggerEvent('onBeforeExportDataToXLSX', [$rows, &$fields, &$headers, 'coupons_list.xlsx']);
		...
		$filePath = EventbookingHelperData::excelExport($fields, $rows, 'coupons_list');
