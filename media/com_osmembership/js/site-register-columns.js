(function (document, $) {
    $(document).ready(function () {
        ...
        var hasSquareUpPaymentMethod = Joomla.getOptions('hasSquareupPaymentMethod');
        ...
        $("#os_form").validationEngine('attach', {
            ...
            onValidationComplete: function (form, status) {
                if (status === true) {
                    ...
                    if (paymentNeeded && (hasStripePaymentMethod || hasSquareUpPaymentMethod)) {
        ...
        var loginButton = document.getElementById('btnLoginButton');
        if (loginButton) {
            loginButton.addEventListener('click', function () {
                ...
                {
                    alert(Joomla.JText._('OSM_ENTER_USERNAME_TO_LOGIN'));
                    usernameInput.focus();
                    return;
                }
                ...
                {
                    alert(Joomla.JText._('OSM_ENTER_PASSWORD_TO_LOGIN'));
                    usernameInput.focus();
                    return;
                }

                document.getElementById('username').value = usernameInput.value;
                document.getElementById('password').value = passwordInput.value;
                document.getElementById('osm_login_form').submit();
            });
        }
    });
})(document, jQuery);