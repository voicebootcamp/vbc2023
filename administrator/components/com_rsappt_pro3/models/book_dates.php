...
class book_datesModelbook_dates extends JModelLegacy
{
	...
	function _buildQueryForListScreen()
	{
		...
		" WHERE #__sv_apptpro3_resources.id_resources = ".$this->getState('filter_resource', 0).
		$orderby;
		//echo $query;
		//exit;
	...
	function setbook_dates_tocopy($book_dates_tocopy){
		$this->_book_dates_tocopy	= $book_dates_tocopy;
	}

	function getbook_dates_tocopy(){
		return $this->_book_dates_tocopy;
	}
