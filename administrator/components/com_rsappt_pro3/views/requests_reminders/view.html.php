...
class requestsViewrequests_reminders extends JViewLegacy
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - send reminders') );
   
   
   		//DEVNOTE: Set ToolBar title
	    JToolBarHelper::title( 'Appointment Booking Pro - '.JText::_('RS1_ADMIN_TOOLBAR_REMINDERS'), '' );
    
    	//DEVNOTE: Set toolbar items for the page
		JToolBarHelper::cancel( 'cancel_reminders', 'Close' );
