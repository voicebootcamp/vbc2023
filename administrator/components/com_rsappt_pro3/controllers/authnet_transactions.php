...
class authnet_transactionsController extends JControllerForm
{
	...
	function display($cachable=false, $urlparams=false) {
		...
		rsappt_pro3Helper::addSubmenu('authnet_transactions');
	...
	function export_data(){
		...
		$sql = "SELECT ".
			  " #__sv_apptpro3_authnet_transactions.*, #__sv_apptpro3_requests.id_requests AS RequestID,".
			  ...
			  " FROM ".
			  " #__sv_apptpro3_authnet_transactions INNER JOIN ".
			  " #__sv_apptpro3_requests ON #__sv_apptpro3_authnet_transactions.x_invoice_num = ".
			  ...
			  " #__sv_apptpro3_resources.id_resources ".
				" WHERE #__sv_apptpro3_authnet_transactions.id_authnet_transactions IN (".implode(",", $uid).")";
		//echo $sql;
		//exit;
		
		ob_end_clean();
			
		$file_name = 'export_sv_authnet_transactions.csv';
