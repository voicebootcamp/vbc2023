	...
	<tr>
		<td align="left">
			<div class="btn-wrapper input-append">
				...
				<button class="btn btn-primary button-select" type="submit"><span class="<?php echo $bootstrapHelper->getClassMapping('icon-search'); ?>"></span></button>
				<button class="btn btn-primary button-select" type="button" onclick="document.getElementById('filter_search').value='';this.form.submit();"><span class="<?php echo $bootstrapHelper->getClassMapping('icon-remove'); ?>"></span></button>
