...
$ordering = ($this->lists['order'] == 'ordering');
	...
	$pdflink = JRoute::_( "index.php?option=com_rsappt_pro3&view=admin")."&task=printer&frompage=admin".
...
<div id="sv_apptpro_fe_admin">
     <table width="100%" >
        ...
        <tr class="fe_admin_header">
          <td >
            <div  id="search_value" style="display: table-cell; padding-left:1px;">
            ...
            <div id="search_icon" style="display: table-cell;"><a href="#" onclick="doSearch();" title="<?php echo JText::_('RS1_ADMIN_APPT_LIST_SEARCH_HELP');?>"><img src="<?php echo $this->baseurl;?>/components/com_rsappt_pro3/search.png" border="0" /></a>
            </div></td>
  ...
  <table width="100%">
    <tr class="fe_admin_header">
      <th class="sv_title" align="center" width="3%"><input type="checkbox" name="toggle" value="" onclick="checkAll2(<?php echo sv_count_($this->items); ?>, 'appt_cb');" /></th>
	...
	$row = $this->items[$i];
//	$link 	= JRoute::_( 'index.php?option=com_rsappt_pro3&view=admin_detail&task=edit&cid='. $row->id_requests.'&frompage=admin');
	$link 	= 'index.php?option=com_rsappt_pro3&view=admin_detail&task=edit&cid='. $row->id_requests.'&frompage=admin';
