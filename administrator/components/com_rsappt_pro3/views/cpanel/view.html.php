...
class cpanelViewcpanel extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - cpanel') );
   
	    JToolBarHelper::title( JText::_( 'RS1_ADMIN_TOOLBAR_CTL_PANEL' ), 'control' );

		rsappt_pro3Helper::addSubmenu('cpanel');
