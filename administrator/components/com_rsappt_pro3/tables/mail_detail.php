...
class Tablemail_detail extends JTable
{
	...
	var $booking_succeeded_sms_customer = null;
	...
	var $thank_you_msg = null;
	var $send_on_status = null;
	var $rebook_msg = null;
	var $birthday_msg = null;
	var $confirmation_attachment = null;
	var $notification_msg = null;	var $checked_out = null;
	...
	function __construct($db) {
	  ...
	  $this->_table_prefix = '#__sv_apptpro3_';
		...
		parent::__construct($this->_table_prefix.'mail', 'id_mail', $db);
	}
...
//		$query = 'SELECT id FROM '.$this->_table_prefix.'mail  WHERE name = "'.$this->name;
