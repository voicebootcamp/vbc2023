...
?>
<form action="index.php?option=com_eventbooking&view=massmail" method="post" name="adminForm" id="adminForm" class="form form-horizontal<?php if (!EventbookingHelper::isJoomla4()) echo ' joomla3'; ?>" enctype="multipart/form-data">
	...
	<div class="control-group">
		...
		<div class="controls">
			<?php echo $editor->display('description', $this->message->mass_mail_template, '100%', '400', '75', '10'); ?>
		</div>
	</div>
