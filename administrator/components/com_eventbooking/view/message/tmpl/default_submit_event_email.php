...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('submit_event_user_email_body', $this->message->submit_event_user_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('submit_event_admin_email_body', $this->message->submit_event_admin_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('event_approved_email_body', $this->message->event_approved_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('event_update_email_body', $this->message->event_update_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
