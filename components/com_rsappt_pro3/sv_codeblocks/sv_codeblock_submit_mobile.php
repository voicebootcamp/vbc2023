...
<div>
 ...
 <?php if($apptpro_config->enable_coupons == "Yes"){ ?>
     <tr class="submit_section">
        <td><div class="control-label"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_COUPONS');?></label></div>
 ...
 <?php if($apptpro_config->enable_gift_cert == "Yes"){ ?>
     <tr class="submit_section">
        <td><div class="control-label"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_GIFT_CERT');?></label></div>
        ...
        <table border="1"  cellpadding="4" cellspacing="0" class="calcResults_outside" align="center" >
          ...
          <tr style="text-align:right">
            <td style="border-bottom:solid 1px; border-right:solid 1px; height:auto;"><div style="float:right">
                            <div style="display: table-cell; padding-left:0px;"><label class="sv_apptpro_request_label" id="currency_label"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?></label></div>
	  ...
	  <?php } ?>
          <tr align="right">
            ...
            <td style="border-bottom:solid 1px; border-right:solid 1px;"><div style="display: table-cell; padding-left:5px; float:right">
                                <div style="display: table-cell; padding-left:5px;"><label class="sv_apptpro_request_label" id="currency_label"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?></label></div>
...
<?php } ?>    
    ...
    <tr class="submit_section">
      <td align="center" ><input  name="cbCopyMe" type="hidden" value="yes"  />
...
<?php } ?>
  ...
  <div class="submit_section">
    <div id="dynamic_recaptcha_1" align="center" class="g-recaptcha" data-sitekey="<?php echo $recapt_params->get('public_key', ''); ?>"
