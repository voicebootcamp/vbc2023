...
<div id="mod_jmediaicons-wrap" class="clearfix">
	<div class="icon-wrapper">
		<div class="icon">
			<a href="<?php echo JRoute::_('index.php?option=com_jmedia'); ?>">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="-20 -10 220 50" height="75px" width="300px">
                                  <g fill="#454c55">
                                  ...
                                  <path d="M8.5 38.83V4.9a3.78 3.78 0 013.77-3.77h26.39a7.56 7.56 0 017.54 7.54v30.16a1.87 1.87 0 01-1.88 1.88H10.39a1.87 1.87 0 01-1.89-1.88z" fill="#fff"></path>
                                  <path d="M46.2 8.67h-3.77a3.78 3.78 0 01-3.77-3.77V1.13a7.56 7.56 0 017.54 7.54z" fill="#fff"></path>
                                  <path d="M47.33 8.67v-.15A8.62 8.62 0 0038.66 0H12.27a4.89 4.89 0 00-4.9 4.9v2.64a1.13 1.13 0 002.26 0V4.9a2.62 2.62 0 012.64-2.64h25.26V4.9a4.89 4.89 0 004.9 4.9h3.77a1.23 1.23 0 001.06-.67 1.89 1.89 0 00.07-.46zM39.77 4.9V2.37a6.39 6.39 0 015.16 5.16h-2.5a2.62 2.62 0 01-2.66-2.63z" fill="#454c55"></path>
                                  <path d="M39.3 17.34H26.67a6.29 6.29 0 01-5-2.45 6.29 6.29 0 00-5-2.45H6.62a1.87 1.87 0 00-1.85 1.88v24.51a1.87 1.87 0 001.88 1.88h34.54V19.22a1.89 1.89 0 00-1.89-1.88z" fill="#fff"></path>
                                  <path d="M11.4 30.13a9.42 9.42 0 1010.58-8.11 9.42 9.42 0 00-10.58 8.11zM1.6 45.73a2.27 2.27 0 01.41-3.17l4.76-3.66a2.27 2.27 0 013.17.41 2.27 2.27 0 01-.41 3.17l-4.76 3.65a2.28 2.28 0 01-3.17-.4z" fill="#fff"></path>
                                  <path d="M20.77 41.88c-.45 0-.94 0-1.39-.08a10.55 10.55 0 119.76-16.89 10.35 10.35 0 012.07 7.8 10.47 10.47 0 01-10.44 9.17zm0-18.85a8.29 8.29 0 00-1.09 16.51 8.22 8.22 0 006.09-1.65 8.13 8.13 0 003.17-5.5 8.22 8.22 0 00-1.66-6.14 8.13 8.13 0 00-5.51-3.18 9.53 9.53 0 00-1.05-.04z" fill="#7fbee8"></path>
                                  <path d="M10.01 40.45a1.12 1.12 0 01-.9-.45 1.11 1.11 0 01.23-1.58l3-2.3a1.1320004 1.1320004 0 111.36 1.81l-3 2.3a1.22 1.22 0 01-.69.22z" fill="#7fbee8"></path>
                                  <path d="M3.41 47.72a1.84 1.84 0 01-.45 0A3.39 3.39 0 01.7 46.44a3.38 3.38 0 01.64-4.75l4.79-3.66a3.4104435 3.4104435 0 014.18 5.39l-4.83 3.66a3.42 3.42 0 01-2.07.64zm-.9-2.68a1.16 1.16 0 00.75.41 1.08 1.08 0 00.83-.23l4.79-3.66a1.16 1.16 0 00.41-.75 1.08 1.08 0 00-.23-.83 1.16 1.16 0 00-.75-.41 1.08 1.08 0 00-.83.23l-4.79 3.66a1.17 1.17 0 00-.19 1.58z" fill="#7fbee8"></path>
                                  <path d="M47.33 16.13v-2.56a1.11 1.11 0 00-1.13-1.13 1.13 1.13 0 00-1.13 1.13v24.62a1.395 1.395 0 11-2.79 0v-19a3 3 0 00-3-3H26.67a5.16 5.16 0 01-4.07-2 7.47 7.47 0 00-5.83-2.88H6.62a3 3 0 00-3 3v19.24a1.13 1.13 0 002.26 0V14.32a.76.76 0 01.75-.75h10.14a5.16 5.16 0 014.07 2 7.47 7.47 0 005.88 2.9H39.3a.76.76 0 01.75.75v19a4.36 4.36 0 00.26 1.39h-8.06a1.13 1.13 0 000 2.26h11.42a3.66 3.66 0 003.66-3.66V16.13z" fill="#454c55"></path>
                                </svg>
				<span><?php echo JText::_('Explore Now'); ?></span>
			</a>
		</div>
	</div>
</div>
