...
<video:description><![CDATA[<?php echo StringHelper::substr($videoItemObject->snippet->description, 0, 2048);?>]]></video:description>
...
<?php endif;?>
<video:publication_date><?php $dateObj = new Date($videoItemObject->snippet->publishedAt); $dateObj->setTimezone(new \DateTimeZone('UTC'));echo $dateObj->toISO8601(true);?></video:publication_date>
