...
class OSMembershipHelperEuvat
{
	...
	public static function validateEUVATNumber($vatNumber)
	{
		...
		$validatedVatNumbers = Factory::getSession()->get('osm_validated_eu_vat_numbers');
		...
		if (is_null($ret))
		{
			try
			{
				...
				$url  = 'https://ec.europa.eu/taxation_customs/vies/viesquer.do?locale=en'
		...
		Factory::getSession()->set('osm_validated_eu_vat_numbers', json_encode($validatedVatNumbers));
