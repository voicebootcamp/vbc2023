	...
	private function drawSettingForm($row)
	{
		...
		?>
            <div class="control-group">
                ...
                <div class="controls">
					<?php echo $lists['auto_coupon_apply_to']; ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input class="input-small form-control" type="number" name="auto_coupon_min_number_registrants" id="auto_coupon_min_number_registrants" size="5" maxlength="250"
                           value="<?php echo $params->get('auto_coupon_min_number_registrants'); ?>"/>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
                ...
                <div class="controls">
                    <input class="input-small form-control" type="number" name="auto_coupon_max_number_registrants" id="auto_coupon_max_number_registrants" size="5" maxlength="250"
                           value="<?php echo $params->get('auto_coupon_max_number_registrants'); ?>"/>
                </div>
            </div>
			<?php
		}
