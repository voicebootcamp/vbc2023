...
<fieldset class="form-horizontal options-form">
    ...
    <div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(array('show_privacy_policy_checkbox' => '1')); ?>'>
		<div class="control-label">
		...
		<div class="controls">
			<?php echo EventbookingHelperHtml::getArticleInput($this->config->privacy_policy_article_id, 'privacy_policy_article_id'); ?>
		</div>
	</div>
    <div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(array('show_privacy_policy_checkbox' => '1')); ?>'>
		<div class="control-label">
