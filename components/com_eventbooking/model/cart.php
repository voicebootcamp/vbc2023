...
class EventbookingModelCart extends RADModel
{
	...
	public function processCheckout(&$data)
	{
		...
		$fees = EventbookingHelper::callOverridableHelperMethod('Registration', 'calculateCartRegistrationFee',
			[$cart, $form, $data, $config, $paymentMethod], 'Helper');
		...
		Factory::getSession()->set('eb_registration_code', $registrationCode);
