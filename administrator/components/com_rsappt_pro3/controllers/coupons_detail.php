...
class coupons_detailController extends JControllerForm
{
	...
	*/
	function edit($key=null, $urlVar=null)
	{
		...
		// Checkin the coupons
		$model = $this->getModel('coupons_detail');
		$model->checkout();
	}
	...
	*/
	function save($key=null, $urlVar=null)
	{
		...
		$model->checkin();
		if($key=="2new"){
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=coupons_detail&task=edit&cid[]=-1',$msg );
		} else {
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=coupons' );
		}
	}
	...
	*/
	...
	/** function saveorder
	*
	* saveorder of the coupons items
	* 			
	* @param array cid		- array of id
