...
class reminderlogModelreminderlog extends JModelLegacy
{
	...
	/**
	 * Method to get a reminderlog data
	 *
	 * this method is called from the owner VIEW by VIEW->get('Data');
	 * - get list of all reminderlog for the current data page.
	...
	/**
	 * Method to get the total number of reminderlog items
	 *
	 * @access public
	 * @return integer
	 */
	...
	/**
	 * Method to get a pagination object for the reminderlog
	 */
	...
	function _buildQuery()
	{
		...
		$query = ' SELECT * FROM '.$this->_table_prefix.'reminderlog'.$orderby;
		//echo $query;
		//exit;
