...
class HTML_OSappscheduleBalance{
	 ...
	 */
	static function listBalances($option,$rows,$pageNav,$lists){
	 ...
	 */
	static function editBalance($row){
		...
		<table class="admintable" >
			...
			<tr>
				...
				<td>
					<input class="input-mini imini required form-control" type="text" name="amount" id="amount" size="40" value="<?php echo $row->amount?>" />
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea name="note" cols="60" rows="4" class="form-control"><?php echo $row->note;?></textarea>
				</td>
			</tr>
		</table>
