...
class SppagebuilderAddonArticles4 extends SppagebuilderAddons
{
	...
	$output	.= '<div class="sppb-row">';
		$output .= '<div class="sppb-col-lg-6">';

				$output .= '<div class="sppb-article-img-wrap">';
				if(!$hide_thumbnail) {
					$image = '';
					if ($resource == 'k2') {
		...
		$output .= '<div class="sppb-col-lg-6">';
				...
				$output .= '<div class="sppb-article-info-wrap">';
					...
					if($show_readmore) {
						$output .= '<a class="sppb-readmore sppb-btn sppb-btn-primary" href="'. $item->link .'" itemprop="url">'. $readmore_text .'</a>';
					}
