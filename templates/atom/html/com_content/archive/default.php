...
.filters {border: none;padding-left:0;}
...
<form id="adminForm" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-inline">
	...
	<div class="filter-search">
		...
		<button type="submit" class="qx-button qx-button-default" style="vertical-align: top;"><?php echo JText::_('JGLOBAL_FILTER_BUTTON'); ?></button>
