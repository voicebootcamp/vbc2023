...
<div class="<?php echo $controlGroupClass; ?>">
	...
	<div class="<?php echo $controlsClass; ?>">
		<input type="text" name="discount_amounts" id="discount_amounts" class="input-medium form-control d-inline-block" size="5" value="<?php echo $this->item->discount_amounts; ?>" />&nbsp;&nbsp;<?php echo $this->lists['discount_type'] ; ?>
	</div>
</div>
<div class="<?php echo $controlGroupClass; ?>">
	<div class="<?php echo $controlLabelClass; ?>">
	...
	<div class="<?php echo $controlsClass; ?>">
		<input type="number" name="early_bird_discount_amount" id="early_bird_discount_amount" class="input-medium form-control d-inline-block" size="5" value="<?php echo $this->item->early_bird_discount_amount; ?>" />&nbsp;&nbsp;<?php echo $this->lists['early_bird_discount_type'] ; ?>
	</div>
</div>
<div class="<?php echo $controlGroupClass; ?>">
	<div class="<?php echo $controlLabelClass; ?>">
