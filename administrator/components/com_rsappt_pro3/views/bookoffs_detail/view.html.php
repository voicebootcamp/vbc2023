 ...
 */
class bookoffs_detailViewbookoffs_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_BOOKOFFS_DETAIL' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit'  );
		JToolBarHelper::save();
		...
		JToolBarHelper::divider();
		JToolBarHelper::help( 'ABPRO2_HELP_BOOKOFF_EDIT', true );    
