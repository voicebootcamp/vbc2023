...
<div class="control-group">
	...
	<div class="controls">
		<input type="number" name="invoice_start_number" class="form-control" value="<?php echo $config->invoice_start_number ? $config->invoice_start_number : 1; ?>" size="10" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	<div class="control-label">
		<?php
		echo EventbookingHelperHtml::getFieldLabel('invoice_format', Text::_('EB_INVOICE_FORMAT'), Text::_('EB_INVOICE_FORMAT_EXPLAIN'));

		$tags          = EventbookingHelperHtml::getSupportedTags('invoice_format');
    ...
    <div class="controls" <?php if (!EventbookingHelper::isJoomla4()) echo 'style="margin-lefT: 28%"'; ?> >
...
<div class="control-group">
	<div class="control-label">
		<?php
			echo EventbookingHelperHtml::getFieldLabel('invoice_format_cart', Text::_('EB_INVOICE_FORMAT_CART'), Text::_('EB_INVOICE_FORMAT_CART_EXPLAIN'));

			$tags          = EventbookingHelperHtml::getSupportedTags('invoice_format_cart');
			$availableTags = '[' . implode(']<br /> [', $tags) . ']';
		?>
        <p class="eb-available-tags">
			<?php echo Text::_('EB_AVAILABLE_TAGS'); ?>: <br /><strong><?php echo $availableTags; ?></strong>
