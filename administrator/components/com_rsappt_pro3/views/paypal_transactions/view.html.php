...
class paypal_transactionsViewpaypal_transactions extends JViewLegacy
{
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_PAYPAL_LIST' ), 'paypal' );
		...
		JToolBarHelper::editList('edit', JText::_('RS1_ADMIN_TOOLBAR_PAYPAL_VIEW'));
		JToolBarHelper::divider();
		JToolBarHelper::custom('export_paypal', 'save', '', JText::_('RS1_ADMIN_TOOLBAR_PAYPAL_EXPORT'));
		JToolBarHelper::divider();
		JToolBarHelper::cancel('cancel', 'JTOOLBAR_CLOSE');
		JToolBarHelper::divider();
		JToolBarHelper::help('ABPRO2_HELP_PAYPAL', true);
