...
class mail_detailViewmail_detail extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - Message Centre') );
		...
		if($jinput->getInt("from_global") == 1){
			$model->setId(1);
		}
		//get the data
		...
		JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_MAIL_DETAIL' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit'  );
		JToolBarHelper::save();
		JToolBarHelper::save2new('save2new');
//		JToolBarHelper::custom( 'copy_from_global', 'copy.png', 'copy_f2.png', JText::_('RS1_ADMIN_TOOLBAR_FROM_GLOBAL'), false);
		if ($isNew)  {
		...
		JToolBarHelper::divider();
		JToolBarHelper::help( 'ABPRO2_HELP_MAIL_EDIT', true );    
