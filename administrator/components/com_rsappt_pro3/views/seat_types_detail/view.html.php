 ...
 */
class seat_types_detailViewseat_types_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_SEAT_DETAIL' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit'  );
		JToolBarHelper::save();
		...
		JToolBarHelper::divider();
		JToolBarHelper::help( 'ABPRO2_HELP_SEAT_EDIT', true );    
