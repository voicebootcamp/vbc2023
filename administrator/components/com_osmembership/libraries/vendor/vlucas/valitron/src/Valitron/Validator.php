...
class Validator
{
	...
	{
		\JLoader::registerNamespace('CodiceFiscale',
			JPATH_ADMINISTRATOR . '/components/com_osmembership/libraries/vendor/davidepastore/codice-fiscale/src', false, true, 'psr4');
