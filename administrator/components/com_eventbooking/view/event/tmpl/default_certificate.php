...
<div class="control-group">
	...
	<div class="controls">
		<?php echo Text::_('EB_LEFT') . '    ';?><input type="number" name="certificate_bg_left" class="input-small form-control d-inline-block" value="<?php echo (int) $this->item->certificate_bg_left; ?>" />
		<?php echo Text::_('EB_TOP') . '    ';?><input type="number" name="certificate_bg_top" class="input-small form-control d-inline-block" value="<?php echo (int) $this->item->certificate_bg_top; ?>" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
	...
	<div class="controls">
		<?php echo Text::_('EB_WIDTH') . ' (mm)   ';?><input type="number" name="certificate_bg_width" class="input-small form-control d-inline-block" value="<?php echo (int) $this->item->certificate_bg_width; ?>" />
		<?php echo Text::_('EB_HEIGHT') . ' (mm)   ';?><input type="number" name="certificate_bg_height" class="input-small form-control d-inline-block" value="<?php echo (int) $this->item->certificate_bg_height; ?>" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
	...
	<div class="controls">
		<?php echo $editor->display('certificate_layout', $this->item->certificate_layout, '100%', '400', '90', '10') ; ?>
	</div>
</div>