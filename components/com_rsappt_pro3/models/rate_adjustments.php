...
class adminModelrate_adjustments extends JModelLegacy
{
	...
	function getPagination()
	{
		...
		if (empty($this->_pagination))
		{
			...
			$this->_pagination = new JPagination( $this->getTotal(), $this->getState('ra_limitstart'), $this->getState('ra_limit') );
		}
	...
	function _buildContentOrderBy()
	{
		...
		$filter_order     = $mainframe->getUserStateFromRequest( $context.'ra_filter_order',      'ra_filter_order', 	  'res_name' );
		$filter_order_Dir = $mainframe->getUserStateFromRequest( $context.'ra_filter_order_Dir',  'ra_filter_order_Dir', '' );		
