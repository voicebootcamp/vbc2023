...
function pagination_list_render($list)
{
	...
	$html .= '<ul class="qx-pagination qx-flex-center">';
...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<span class="icon-previous" aria-hidden="true" qx-pagination-previous></span>';
		$aria    = JText::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
	}
	...
	{
		$display = '<span class="icon-next" aria-hidden="true" qx-pagination-next></span>';
		$aria    = JText::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
	}
	...
	return '<li' . $class . '><a title="' . $item->text . '" href="' . $item->link . '" aria-label="' . $aria . '">' . $display . '</a></li>';
...
function pagination_item_inactive(&$item)
{
	...
	if (isset($item->active) && $item->active)
	{
		...
		return '<li class="qx-active hidden-phone"><a aria-current="true" aria-label="' . $aria . '">' . $item->text . '</a></li>';
	}
