...
<table class="table table-striped" >
   ...
   ?>
    <tr>
      ...
      <td class="center"  style="border-right:thin solid #CCC"><?php echo ($row->rate_adjustment_unit=="Flat"?JText::_('RS1_ADMIN_RATE_ADJUSTMENT_RATE_UNIT_FLAT'):($row->rate_adjustment_unit=="Per_Seat"?JText::_('RS1_ADMIN_RATE_ADJUSTMENT_RATE_UNIT_PERSEAT'):JText::_('RS1_ADMIN_RATE_ADJUSTMENT_RATE_UNIT_PERCENT'))); ?></td>
