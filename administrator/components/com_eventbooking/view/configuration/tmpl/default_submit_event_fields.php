...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_min_group_number', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_MIN_NUMBER_REGISTRANTS'))); ?>
    </div>
    <div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('fes_show_min_group_number', $config->get('fes_show_min_group_number', 0)); ?>
    </div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_members_discount_apply_for', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_MEMBERS_DISCOUNT_APPLY_FOR'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('fes_show_members_discount_apply_for', $config->get('fes_show_members_discount_apply_for', 0)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_activate_waiting_list', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_ENABLE_WAITING_LIST'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('fes_show_activate_waiting_list', $config->get('fes_show_activate_waiting_list', 0)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_collect_member_information', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_COLLECT_MEMBER_INFORMATION'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('fes_show_collect_member_information', $config->get('fes_show_collect_member_information', 0)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_prevent_duplicate_registration', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_PREVENT_DUPLICATE'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('fes_show_prevent_duplicate_registration', $config->get('fes_show_prevent_duplicate_registration', 0)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
