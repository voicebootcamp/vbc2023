...
// Framework JS validation
$datavalidation = $field->getAttribute('datavalidation', null);
$validation = $datavalidation ? ' data-validation="' . $datavalidation . '"' : '';
...
$addonBeforeHtml = '<span class="input-group-text">' . $addonBefore . '</span>';
$addonAfterHtml  = '<span class="input-group-text">' . $addonAfter . '</span>';
?>
