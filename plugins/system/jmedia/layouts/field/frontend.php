...
$attr .= !empty($class) ? ' class="input-small form-control ' . $class . '"' : ' class="input-small"';
...
// The text field.
echo '<div id="jmedia-input-group" class="input-group">';
...
<div class="input-group-append">
	<a class="modal modal-btn btn btn-primary" style="display: block!important;" title="<?php echo JText::_('JLIB_FORM_BUTTON_SELECT'); ?>" href="
	<?php echo ($readonly ? ''
			: ($link ?: 'index.php?option=com_media&amp;view=images&amp;tmpl=component&amp;asset=' . $asset . '&amp;author='
		. $authorField) . '&amp;fieldid=' . $id . '&amp;folder=' . $folder) . '"'
		. ' rel="{handler: \'iframe\', size: {x: 1024, y: 600}}"'; ?>>
	 <?php echo JText::_('JLIB_FORM_BUTTON_SELECT'); ?></a>
	 <a class="btn btn-danger hasTooltip" title="<?php echo JText::_('JLIB_FORM_BUTTON_CLEAR'); ?>" href="#" onclick="jInsertFieldValue('', '<?php echo $id; ?>'); return false;">
