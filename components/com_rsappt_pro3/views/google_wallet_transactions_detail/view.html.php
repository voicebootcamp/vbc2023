 ...
 */
class admin_detailViewgoogle_wallet_transactions_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		//$document->setTitle( JText::_('Appointment Booking Pro - google_wallet_transactions') );

		$uri = JUri::getInstance()->toString();
		$user = JFactory::getUser();

		require_once(JPATH_COMPONENT.DIRECTORY_SEPARATOR.'models'.DIRECTORY_SEPARATOR.'google_wallet_transactions_detail.php');
		$model = new admin_detailModelgoogle_wallet_transactions_detail;
		...
		$isNew		= ($detail->id_google_wallet_transactions < 1);
