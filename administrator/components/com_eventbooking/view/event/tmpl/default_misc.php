...
?>
<fieldset class="form-horizontal options-form eb-event-misc">
	...
	<div class="control-group">
		...
		<div class="controls">
			<?php echo EventbookingHelperHtml::getUserInput($this->item->created_by, 'created_by', 1); ?>
		</div>
	</div>
	<?php
	...
	?>
		<div class="control-group">
			...
			<div class="controls">
				<input type="number" name="min_group_number" id="min_group_number" class="input-small form-control" size="10" value="<?php echo $this->item->min_group_number; ?>"/>
			</div>
		</div>
	<?php
	}
	...
	?>
		<div class="control-group">
			...
			<div class="controls">
				<input type="number" name="max_group_number" id="max_group_number" class="input-small form-control" size="10" value="<?php echo $this->item->max_group_number; ?>"/>
			</div>
		</div>
	<?php
	}
	...
	{
		if ($this->config->get('bes_user_registration', 1))
		{
		?>
			<div class="control-group">
				<div class="control-label">
	...
	?>
		<div class="control-group">
			<div class="control-label">
                <?php echo EventbookingHelperHtml::getFieldLabel('deposit_amount', Text::_('EB_DEPOSIT_AMOUNT'), Text::_('EB_DEPOSIT_AMOUNT_EXPLAIN')); ?>
			</div>
			<div class="controls">
				<input type="number" name="deposit_amount" id="deposit_amount" class="input-small form-control" size="5" value="<?php echo $this->item->deposit_amount; ?>"/>&nbsp;&nbsp;<?php echo $this->lists['deposit_type']; ?>
			</div>
		</div>
        <div class="control-group">
            <div class="control-label">
	            <?php echo EventbookingHelperHtml::getFieldLabel('deposit_until_date', Text::_('EB_DEPOSIT_UNTIL_DATE'), Text::_('EB_DEPOSIT_UNTIL_DATE_EXPLAIN')); ?>
            </div>
            <div class="controls">
				<?php echo HTMLHelper::_('calendar', $this->item->deposit_until_date, 'deposit_until_date', 'deposit_until_date', $this->datePickerFormat . ' %H:%M', ['class' => 'input-medium', 'showTime' => true]); ?>
            </div>
        </div>
	<?php
	}
	...
	{
	?>
		<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['enable_cancel_registration' => '1']); ?>'>
			<div class="control-label">
