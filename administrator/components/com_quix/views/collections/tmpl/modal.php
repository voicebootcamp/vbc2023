...
<form action="<?php echo JRoute::_('index.php?option=com_quix&view=collections&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken() . '=1'); ?>" method="post"
      name="adminForm" id="adminForm">
        ...
        <div id="filter-bar" class="btn-toolbar">
            <div class="filter-search input-append input-group pull-left">
            ...
            <div class="btn-group pull-right hidden-phone" style="width: 50%">
                <label for="limit"
                       class="element-invisible">
                    <?php echo JText::_('JFIELD_PLG_SEARCH_SEARCHLIMIT_DESC'); ?>
                </label>
                <span style="display: block;text-align: right;    width: 100%;"><?php echo $this->pagination->getLimitBox(); ?></span>
            </div>
        </div>
...
<style>
  ...
  #filter-bar{margin: 0 10px 25px;background: #eee;padding: 10px;}
  ...
  .qx-collection-title{ width: 60%; float: left; }
  .label{
    background: #fafbfb;
    padding: 3px 7px;
