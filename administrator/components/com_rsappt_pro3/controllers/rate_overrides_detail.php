...
class rate_overrides_detailController extends JControllerForm
{
	...
	*/
	function edit($key=null, $urlVar=null)
	{
		...
		$jinput->set( 'view', 'rate_overrides_detail' );
		...
		// Checkin the rate_overrides
		$model = $this->getModel('rate_overrides_detail');
		$model->checkout();
	}
	...
	*/
	function save($key=null, $urlVar=null)
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=rate_overrides',$msg );
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=rate_overrides' );
		}
	}
