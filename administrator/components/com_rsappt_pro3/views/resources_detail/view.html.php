 ...
 */
class resources_detailViewresources_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_RES_DETAIL' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit' );
		JToolBarHelper::save();
		...
		JToolBarHelper::divider();
		JToolBarHelper::help( 'ABPRO2_HELP_RESOURCE_EDIT', true );    
