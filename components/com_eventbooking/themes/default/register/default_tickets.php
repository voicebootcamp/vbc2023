...
Factory::getDocument()->addScriptOptions('onlyAllowRegisterOneTicketType', (bool) $params->get('only_allow_register_one_ticket_type'));
			...
			<td class="center">
				<?php
					...
					if ($available > 0)
					{
						...
						echo HTMLHelper::_('select.integerlist', 0, $available, 1, $fieldName, 'class="ticket_type_quantity form-select input-small"', $this->input->getInt($fieldName, 0));
					}
					else
					{
						echo Text::_('EB_NA');
