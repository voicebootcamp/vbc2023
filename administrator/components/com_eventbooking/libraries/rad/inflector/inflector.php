...
/**
 * The RADInflector is a direct copy of Koowa's KInflector class, which
...
class RADInflector
{
	 ...
	 * @var array
	 */
	protected static $_cache = ['singularized' => [], 'pluralized' => []];
	...
	{
		// Return early if an empty $word is passed
		if (!$word)
		{
			return $word;
		}
