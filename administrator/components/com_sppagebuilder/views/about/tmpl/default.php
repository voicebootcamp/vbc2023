						...
						<div class="sp-pagebuilder-about">
							...
							<div class="sp-pagebuilder-information">
								<div class="sp-pagebuilder-title">
									<h2>SP Page Builder Pro</h2> <span>Version: <?php echo SppagebuilderHelper::getVersion(); ?></span>
								</div>
							...
							<div class="sp-pagebuilder-row">
								<div class="col-md-3">
									<div class="sp-pagebuilder-card">
										...
										<a class="btn btn-default btn-sm" href="<?php echo JRoute::_('index.php?option=com_sppagebuilder&view=page&layout=edit'); ?>">Create a Page</a>
									</div>
								</div>
