...
Factory::getDocument()->addScript(Uri::root(true) . '/media/com_osmembership/js/admin-language-default.min.js');
?>
                ...
                foreach ($original as  $key=>$value)
                {
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="<?php echo $key; ?>" class="form-control input-xxlarge eb-language-item-value" value="<?php echo $this->escape($translatedValue);  ?>" />
                                <?php
                                    if ($missing)
                                    {
                                    ?>
