...
class products_detailController extends JControllerForm
{
	...
	*/
	function edit($key=null, $urlVar=null)
	{
		...
		$jinput->set( 'view', 'products_detail' );
		...
		// Checkin the products
		$model = $this->getModel('products_detail');
		$model->checkout();
	}
	...
	*/
	function save($key=null, $urlVar=null)
	{
		...
		$model->checkin();
		if($key=="2new"){
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=products_detail&task=edit&cid[]=-1',$msg );
		} else {
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=products',$msg );
		}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=products' );
		}
	}
	...
	*/
	...
	/** function saveorder
	*
	* saveorder of the products items
	* 			
	* @param array cid		- array of id
