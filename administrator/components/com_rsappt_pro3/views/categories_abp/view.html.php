...
class categories_abpViewcategories_abp extends JViewLegacy
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title( 'Appointment Booking Pro - '.JText::_('RS1_ADMIN_TOOLBAR_CATEGORIES' ), 'categories' );
		...
		JToolBarHelper::divider();
		JToolBarHelper::help( 'ABPRO2_HELP_CATEGORIES', true );    
