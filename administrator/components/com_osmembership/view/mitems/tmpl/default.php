...
?>
<form action="index.php?option=com_osmembership&view=mitems" method="post" name="adminForm" id="adminForm">
	<div id="j-main-container"<?php if ($isJoomla4) echo ' class="mp-joomla4-container"'; ?>>
		...
		<table class="adminlist table table-striped">
			...
			{
				$row       = $this->items[$i];
				$link      = Route::_('index.php?option=com_osmembership&view=mitem&id=' . $row->id);
				?>
