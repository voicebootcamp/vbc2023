...
<table border="0" cellpadding="4" cellspacing="0">
   <tr>
    ...
    <tr class="admin_detail_row1">
      ...
      <td colspan="2"><?php echo $this->detail->id_bookoffs ?></td>
    </tr>
    ...
    <tr class="admin_detail_row1">
      <td valign="top"><?php echo JText::_('RS1_ADMIN_SCRN_BO_DAILY');?> </td>
      ...
      <td>
        ...
        <input type="text" readonly="readonly" id="display_picker_date" name="display_picker_date" class="sv_date_box" size="10" maxlength="10" 
		   ...
		   <?php if($this->detail->id_bookoffs == ""){ ?>
            &nbsp;<?php echo JText::_('RS1_ADMIN_SCRN_BO_DATE_TO');?>&nbsp;
            ...
            <td><?php echo JText::_('RS1_ADMIN_SCRN_BO_DATE_HELP');?><label id="daily_bookoff_help"><?php echo $daily_note;?></label></td>
            </tr>
            <tr class="admin_detail_row0">
            <td><?php echo JText::_('RS1_ADMIN_SCRN_BO_DATE_DAYS');?></td>
            <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="left">
            ...
            <td><?php echo JText::_('RS1_ADMIN_SCRN_BO_DATE_DAYS_HELP');?></td>
            </tr> 
            </td>
            <?php } else { ?>
            </td><td><label id="daily_bookoff_help"><?php echo $daily_note;?></label></td>
            <?php } ?>
    </tr>
    <tr class="admin_detail_row1">
      <td><?php echo JText::_('RS1_ADMIN_SCRN_BO_FULLDAY');?> </td>
      <td><select name="full_day" id="full_day" class="sv_apptpro3_request_text">
    ...
    <tr class="admin_detail_row1">
      ...
      <td><select name="bookoff_starttime_hour" id="bookoff_starttime_hour" style="width:auto;" onchange="setbookoffstarttime();" class="sv_apptpro3_requests_dropdown" >
		<?php
		for($x=0; $x<24; $x+=1){
			if($x<10){
				$x = "0".$x;
    ...
    <tr class="admin_detail_row1">
      ...
      <td><select name="bookoff_endtime_hour" id="bookoff_endtime_hour" style="width:auto;" onchange="setbookoffendtime();" class="sv_apptpro3_requests_dropdown" >
		<?php
		for($x=0; $x<24; $x+=1){
			if($x<10){
				$x = "0".$x;
