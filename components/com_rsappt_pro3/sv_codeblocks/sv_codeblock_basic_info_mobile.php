...
<div>
  <table>
    <tr>
      <td>
      <div class="control-label"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_NAME');?>&nbsp;<?php echo $required_symbol;?></label></div>
    ...
    <tr>
      <td>
      <div class="control-label"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_PHONE');?>&nbsp;<?php echo ($apptpro_config->requirePhone == "Yes"?$required_symbol:"")?></label></div>
    ...
    <tr>
      <td><div class="control-label"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_SMS_LABEL');?></label></div>
    ...
    <?php } else { ?>
    <tr>
      <td><div class="control-label"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_EMAIL');?>&nbsp;<?php echo ($apptpro_config->requireEmail == "Yes"?$required_symbol:"")?></label></div>
      <div class="controls">
...
<?php include_once JPATH_SITE."/components/com_rsappt_pro3/add_to_notification_list.php" ?>
