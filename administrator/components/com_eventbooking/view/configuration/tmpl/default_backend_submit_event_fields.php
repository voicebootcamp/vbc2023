...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('bes_show_send_third_reminder', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_SEND_THIRD_REMINDER'))); ?>
    </div>
    <div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('bes_show_send_third_reminder', $config->get('bes_show_send_third_reminder', 1)); ?>
    </div>
</div>
<div class="control-group">
	<div class="control-label">
