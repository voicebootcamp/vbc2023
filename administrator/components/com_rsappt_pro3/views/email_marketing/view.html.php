 ...
 */
class email_marketingViewemail_marketing extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - Email Marketing') );
		...
		$isNew		= ($detail->id_email_marketing < 1);
		...
		JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_EMAIL_MARKETING' ), 'email_marketing'  );
		JToolBarHelper::save('save', 'JTOOLBAR_SAVE');
		JToolBarHelper::divider();
		JToolBarHelper::cancel( 'cancel', 'JTOOLBAR_CANCEL' );
		JToolBarHelper::divider();
		JToolBarHelper::help( 'screen.rsappt_pro.email_marketing', true );    
