 ...
 */
class rate_overrides_detailViewrate_overrides_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		$isNew		= ($detail->id_rate_overrides < 1);
		...
		JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_RATE_OVERRIDES' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit'  );
		JToolBarHelper::save();
		if ($isNew)  {
		...
		JToolBarHelper::divider();
		JToolBarHelper::help( 'screen.rsappt_pro.rate_overrides_edit', true );    
