...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_quix&task=themes.saveOrderAjax&tmpl=component';
...
?>
<form
	action="<?php echo JRoute::_('index.php?option=com_quix&view=themes'); ?>"
	method="post" name="adminForm" id="adminForm" class="clearfix">
				...
				<table class="table table-striped" id="pageList">
					...
					<tbody>
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td class="center">
								<div class="btn-group">
									<?php echo JHtml::_('jgrid.published', $item->state, $i, 'themes.', $canChange, 'cb'); ?>
									<a class="btn btn-micro" target="_blank"
										href="<?php echo JUri::root() . 'index.php?option=com_quix&view=collection&layout=iframe&tmpl=component&id=' . $item->id; ?>">
										<i class="icon-eye"></i>
									</a>
									<?php
                                    // Create dropdown items
                                    JHtml::_('actionsdropdown.duplicate', 'cb' . $i, 'themes');
                                    JHtml::_('actionsdropdown.archive', 'cb' . $i, 'themes');
							...
							<td>
								...
								<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'themes.', $canCheckin); ?>
								<?php endif; ?>
								<?php if ($canEdit) : ?>
								<?php
							...
							<td>
								<span class="label label-info"><?php echo ucfirst($item->type); ?></span>
							</td>
						</tr>
						<?php endforeach; ?>
					</tbody>
...
<?php
    $layoutData = [
        'selector' => 'newLibraryModal',
        'params' => [
            'url' => 'index.php?option=com_quix&view=themes&layout=new&tmpl=component',
            'title' => JText::_('Create new Theme'),
            'bodyHeight' => '70',
            'modalWidth' => '80',
            'height' => '600',
            'width' => '1280'
