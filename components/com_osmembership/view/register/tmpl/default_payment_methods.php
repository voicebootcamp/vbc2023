        ...
        <div class="<?php echo $controlsClass; ?>">
            <div id="field_zip_input">
                <input type="text" id="sq_billing_zipcode" name="sq_billing_zipcode"
                       class="input-large<?php echo $bootstrapHelper->getFrameworkClass('uk-input', 1); ?> form-control"
...
<div class="<?php echo $controlGroupClass; ?> payment_information" id="tr_card_number" <?php echo $style; ?>>
    ...
    <div class="<?php echo $controlsClass; ?>">
	    <?php if ($this->hasSquareup) echo '<div id="sq-card-number">'; ?>
            <input type="text" name="x_card_num" class="validate[required]><?php echo $bootstrapHelper->getFrameworkClass('uk-input', 1); ?> form-control" value="<?php echo $this->escape($this->input->post->getAlnum('x_card_num'));?>" size="20" />
	    <?php if ($this->hasSquareup) echo '</div>'; ?>
    </div>
</div>
<div class="<?php echo $controlGroupClass; ?> payment_information" id="tr_exp_date" <?php echo $style; ?>>
    ...
    <div class="<?php echo $controlsClass; ?>">
	    <?php if ($this->hasSquareup) echo '<div id="sq-expiration-date">'; ?>
...
<div class="<?php echo $controlGroupClass; ?> payment_information" id="tr_cvv_code" <?php echo $style; ?>>
    ...
    <div class="<?php echo $controlsClass; ?>">
	    <?php if ($this->hasSquareup) echo '<div id="sq-cvv">'; ?>
            <input type="text" name="x_card_code" class="validate[required,custom[number]]<?php echo $bootstrapHelper->getFrameworkClass('uk-input', 1); ?> form-control" value="<?php echo $this->escape($this->input->post->getString('x_card_code')); ?>" size="20" />
	    <?php if ($this->hasSquareup) echo '</div>'; ?>
    </div>
</div>
<?php
...
<div class="<?php echo $controlGroupClass; ?> payment_information" id="tr_card_holder_name" <?php echo $style; ?>>
	...
	<div class="<?php echo $controlsClass; ?>">
		<input type="text" name="card_holder_name" class="validate[required]<?php echo $bootstrapHelper->getFrameworkClass('uk-input', 1); ?> form-control"  value="<?php echo $this->input->post->getString('card_holder_name'); ?>" size="40" />
	</div>
</div>
