...
echo HTMLHelper::_($tabApiPrefix . 'startTabSet', 'plan-translation', array('active' => 'translation-page-' . $this->languages[0]->sef));

foreach ($this->languages as $language)
{
	$sef = $language->sef;
	echo HTMLHelper::_($tabApiPrefix . 'addTab', 'plan-translation', 'translation-page-' . $sef, $language->title . ' <img src="' . $rootUri . '/media/mod_languages/images/' . $language->image . '.gif" />');
	?>
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea rows="5" cols="30" class="form-control input-large" name="meta_keywords_<?php echo $sef; ?>"><?php echo $this->item->{'meta_keywords_' . $sef}; ?></textarea>
		</div>
	</div>
	<div class="control-group">
		<div class="control-label">
		...
		<div class="controls">
			<textarea rows="5" cols="30" class="form-control input-large" name="meta_description_<?php echo $sef; ?>"><?php echo $this->item->{'meta_description_' . $sef}; ?></textarea>
		</div>
	</div>
	<?php
	...
	?>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="user_email_subject_<?php echo $sef; ?>" class="form-control" value="<?php echo $this->item->{'user_email_subject_' . $sef}; ?>" size="40" />
			</div>
		</div>
		<div class="control-group">
			<div class="control-label">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="subscription_approved_email_subject_<?php echo $sef; ?>" class="form-control" value="<?php echo $this->item->{'subscription_approved_email_subject_' . $sef}; ?>" size="40" />
			</div>
		</div>
		<div class="control-group">
			<div class="control-label">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="user_renew_email_subject_<?php echo $sef; ?>" class="form-control" value="<?php echo $this->item->{'user_renew_email_subject_' . $sef}; ?>" size="40" />
			</div>
		</div>
		<div class="control-group">
			<div class="control-label">
