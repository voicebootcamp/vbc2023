 ...
 */
class admin_detailViewauthnet_aim_transactions_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		//$document->setTitle( JText::_('Appointment Booking Pro - authnet_aim_transactions') );

		$uri = JUri::getInstance()->toString();
		$user = JFactory::getUser();

		require_once(JPATH_COMPONENT.DIRECTORY_SEPARATOR.'models'.DIRECTORY_SEPARATOR.'authnet_aim_transactions_detail.php');
		$model = new admin_detailModelauthnet_aim_transactions_detail;
		...
		$isNew		= ($detail->id_authnet_aim_transactions < 1);
