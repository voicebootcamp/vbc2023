...
?>
<form action="<?php echo Route::_('index.php?option=com_eventbooking&view=location&Itemid=' . $this->Itemid, false); ?>" method="post" name="adminForm" id="adminForm" class="form">
<div class="row-fluid">
	<div  class="<?php echo $span5Class ?>">
		<div class="<?php echo $controlGroupClass;  ?>">
			...
			<div class="<?php echo $controlsClass; ?>">
				<input class="form-control" type="text" name="name" id="name" size="50" maxlength="250" value="<?php echo $this->escape($this->item->name);?>" />
			</div>
		</div>
		...
		<div class="<?php echo $controlGroupClass;  ?>">
			...
			<div class="<?php echo $controlsClass; ?>">
				 <input class="input-xlarge form-control" type="text" name="address" id="address" size="70" autocomplete="off" maxlength="250" value="<?php echo $this->escape($this->item->address);?>" />
