...
class resources_detailController extends JControllerForm
{
	...
	*/
	function edit($key=null, $urlVar=null)
	{
		...
		// Checkin the resources
		$model = $this->getModel('resources_detail');
		$model->checkout();
	}
	...
	*/
	...
	{		
		...
		$model->checkin();
		if($key=="2new"){
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=resources_detail&task=edit&cid[]=-1',$msg );
		} else {
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=resources' );
		}
	}
	...
	*/
	...
	/** function saveorder
	*
	* saveorder of the resources items
	* 			
	* @param array cid		- array of id
