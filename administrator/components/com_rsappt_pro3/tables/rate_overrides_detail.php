...
* udfs Table class
*/
class Tablerate_overrides_detail extends JTable
{
	protected $_supportNullValue = true; 
	
	var $id_rate_overrides = null;
	var $entity_type = null;
	var $entity_id = null;
	var $group_id = null;
	var $rate_override = null;
	var $rate_unit_override = null;	var $checked_out = null;
	...
	function __construct($db) {
	  ...
	  $this->_table_prefix = '#__sv_apptpro3_';
		...
		parent::__construct($this->_table_prefix.'rate_overrides', 'id_rate_overrides', $db);
	}
