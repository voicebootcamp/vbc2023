...
?>
	<div class="<?php echo $controlGroupClass;?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<input type="number" name="individual_price" id="individual_price" class="input-medium form-control" size="10" value="<?php echo $this->item->individual_price; ?>" />
		</div>
	</div>
<?php
}
...
if ($this->config->get('activate_simple_tax') && $this->config->get('fes_tax_rate', 1))
{
?>
    <div class="<?php echo $controlGroupClass;?>">
        <div class="<?php echo $controlLabelClass; ?>">
        ...
        <div class="<?php echo $controlsClass; ?>">
            <input type="number" name="tax_rate" id="tax_rate" class="input-medium form-control" size="10" value="<?php echo $this->item->tax_rate; ?>" />
        </div>
    </div>
<?php
}
...
?>
	<div class="<?php echo $controlGroupClass;?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<input type="number" min="0" step="1" name="event_capacity" id="event_capacity" class="input-medium form-control" size="10" value="<?php echo $this->item->event_capacity; ?>" />
		</div>
	</div>
<?php
}
...
?>
	<div class="<?php echo $controlGroupClass;?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<input type="number" min="0" step="1" name="waiting_list_capacity" id="waiting_list_capacity" class="input-medium form-control" size="10" value="<?php echo $this->item->waiting_list_capacity; ?>" />
		</div>
	</div>
<?php
}
...
?>
    <div class="<?php echo $controlGroupClass;?>">
        ...
        <div class="<?php echo $controlsClass; ?>">
            <input type="number" name="min_group_number" id="min_group_number" class="input-medium form-control" size="10" value="<?php echo $this->item->min_group_number; ?>" />
        </div>
    </div>
<?php
}
...
?>
	<div class="<?php echo $controlGroupClass;?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<input type="number" name="max_group_number" id="max_group_number" class="input-medium form-control" size="10" value="<?php echo $this->item->max_group_number; ?>" />
		</div>
	</div>
<?php
}
...
?>
	<div class="<?php echo $controlGroupClass;?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<input type="number" class="form-control input-medium d-inline-block" name="send_first_reminder" value="<?php echo $this->item->send_first_reminder; ?>" size="5" /><span><?php echo ' ' . $this->lists['first_reminder_frequency'] . ' ' . $this->lists['send_first_reminder_time']; ?></span><?php echo Text::_('EB_EVENT_STARTED'); ?>
		</div>
	</div>
	<div class="<?php echo $controlGroupClass;?>">
		<div class="<?php echo $controlLabelClass; ?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<input type="number" class="form-control input-medium d-inline-block" name="send_second_reminder" value="<?php echo $this->item->send_second_reminder; ?>" size="5" /><span><?php echo ' ' . $this->lists['second_reminder_frequency'] . ' ' . $this->lists['send_second_reminder_time']; ?></span><?php echo Text::_('EB_EVENT_STARTED'); ?>
		</div>
	</div>
<?php
}
