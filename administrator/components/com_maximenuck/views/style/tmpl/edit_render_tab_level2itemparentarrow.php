...
<div class="ckrow">
	<div class="ckbutton-group">
		...
		<label class="ckbutton first" for="level2itemnormalstylesparentarrowtypetriangle" style="width:auto;"><?php echo JText::_('CK_TRIANGLE'); ?>
		...
		<label class="ckbutton"  for="level2itemnormalstylesparentarrowtypeimage" style="width:auto;"><?php echo JText::_('CK_IMAGE'); ?>
		...
		<label class="ckbutton"  for="level2itemnormalstylesparentarrowtypenone" style="width:auto;"><?php echo JText::_('CK_NONE'); ?>
		</label>
	</div>
</div>
...
<div class="ckrow">
	...
	<input type="text" id="level2itemnormalstylesparentarrowcolor" name="level2itemnormalstylesparentarrowcolor" class="level2itemnormalstyles cktip <?php echo $this->colorpicker_class; ?>" title="<?php echo JText::_('CK_PARENTARROWCOLOR_DESC'); ?>" />
	<img class="ckicon" src="<?php echo $this->imagespath ?>/color.png" />
	<span><?php echo JText::_('CK_HOVER'); ?></span>
	<input type="text" id="level2itemhoverstylesparentarrowcolor" name="level2itemhoverstylesparentarrowcolor" class="level2itemhoverstyles cktip <?php echo $this->colorpicker_class; ?>" title="<?php echo JText::_('CK_PARENTARROWHOVERCOLOR_DESC'); ?>" />
	<br/>
	<label></label>
	<img class="ckicon" src="<?php echo $this->imagespath ?>/color.png" />
	<span><?php echo JText::_('CK_ACTIVE'); ?></span>
	<input type="text" id="level2itemactivestylesparentarrowcolor" name="level2itemactivestylesparentarrowcolor" class="level2itemactivestyles cktip <?php echo $this->colorpicker_class; ?>" title="<?php echo JText::_('CK_PARENTARROWACTIVECOLOR_DESC'); ?>" />
	<img class="ckicon" src="<?php echo $this->imagespath ?>/color.png" />
	<span><?php echo JText::_('CK_ACTIVE_HOVER'); ?></span>
	<input type="text" id="level2itemactivehoverstylesparentarrowcolor" name="level2itemactivehoverstylesparentarrowcolor" class="level2itemactivehoverstyles cktip <?php echo $this->colorpicker_class; ?>" title="<?php echo JText::_('CK_PARENTARROWACTIVECOLOR_DESC'); ?>" />
...
<div class="ckrow">
	...
	<span><img class="ckicon" src="<?php echo $this->imagespath ?>/width.png" /></span><span style="width:45px;"><input type="text" id="level2itemnormalstylesparentarrowwidth" name="level2itemnormalstylesparentarrowwidth" class="level2itemnormalstyles cktip" style="width:45px;" title="<?php echo JText::_('CK_WIDTH_DESC'); ?>" /></span>
	<span><img class="ckicon" src="<?php echo $this->imagespath ?>/height.png" /></span><span style="width:45px;"><input type="text" id="level2itemnormalstylesparentarrowheight" name="level2itemnormalstylesparentarrowheight" class="level2itemnormalstyles cktip" style="width:45px;" title="<?php echo JText::_('CK_HEIGHT_DESC'); ?>" /></span>
</div>


<div class="ckrow">
	<label for="level2itemnormalstylesparentitemimage"><?php echo JText::_('CK_BACKGROUNDIMAGE_LABEL'); ?></label>
	<img class="ckicon" src="<?php echo $this->imagespath ?>/image.png" />
	<div class="ckbutton-group">
		<input type="text" id="level2itemnormalstylesparentitemimage" name="level2itemnormalstylesparentitemimage" class="cktip level2itemnormalstyles" title="<?php echo JText::_('CK_BACKGROUNDIMAGE_DESC'); ?>" style="max-width: none; width: 150px;"/>
		<a class="ckbutton" onclick="ckCallImageManagerPopup('level2itemnormalstylesparentitemimage')" href="javascript:void(0)" ><?php echo JText::_('CK_SELECT'); ?></a>
		<a class="ckbutton" href="javascript:void(0)" onclick="$ck(this).parent().find('input').val('');"><?php echo JText::_('CK_CLEAR'); ?></a>
	</div>
</div>
<div class="ckrow">
	<label></label>
	<span><img class="ckicon" src="<?php echo $this->imagespath ?>/offsetx.png" /></span><span style="width:45px;"><input type="text" id="level2itemnormalstylesparentitemimageleft" name="level2itemnormalstylesparentitemimageleft" class="level2itemnormalstyles cktip" style="width:45px;" title="<?php echo JText::_('CK_BACKGROUNDPOSITIONX_DESC'); ?>" /></span>
	<span><img class="ckicon" src="<?php echo $this->imagespath ?>/offsety.png" /></span><span style="width:45px;"><input type="text" id="level2itemnormalstylesparentitemimagetop" name="level2itemnormalstylesparentitemimagetop" class="level2itemnormalstyles cktip" style="width:45px;" title="<?php echo JText::_('CK_BACKGROUNDPOSITIONY_DESC'); ?>" /></span>
	<div class="ckbutton-group">
