...
<div class="reset-confirm<?php echo $this->pageclass_sfx; ?>">
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=reset.confirm'); ?>" method="post" class="form-validate form-horizontal well qx-form-stacked">
			...
			<fieldset class="qx-fieldset">
				...
				<div class="qx-margin">
					<div class="qx-form-controls">
						<label class="qx-form-label" ><?php echo JText::_('COM_USERS_FIELD_RESET_CONFIRM_USERNAME_LABEL'); ?></label>
