...
?>
<div id="osm-my-articles" class="osm-container">
    <?php
        ...
        ?>
	        <<?php echo $hTag; ?> class="osm-page-title"><?php echo $this->params->get('page_heading') ?: Text::_('OSM_MY_ARTICLES'); ?></<?php echo $hTag; ?>>
	    <?php
        }
