...
class front_deskViewcustomer_history extends JViewLegacy
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - Customer History') );
