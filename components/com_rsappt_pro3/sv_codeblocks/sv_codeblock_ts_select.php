...
/*
 ****************************************************************
 Copyright (C) 2008-2016 Soft Ventures, Inc. All rights reserved.
 ****************************************************************
   ...
   <div id="datetime" style="display: none">
    <div class="sv_table">
     <div class="sv_table_row" id="datetime">
      <div class="sv_table_cell_name"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_DATETIME');?></label></div>
