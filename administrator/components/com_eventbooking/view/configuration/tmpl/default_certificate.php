...
<div class="control-group">
	...
	<div class="controls">
		<input type="number" name="certificate_number_length" class="form-control" value="<?php echo $config->get('certificate_number_length', 5); ?>" size="10" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo Text::_('EB_LEFT') . '    ';?><input type="number" name="default_certificate_bg_left" class="form-control input-small d-inline-block" value="<?php echo (int) $config->default_certificate_bg_left; ?>" />
		<?php echo Text::_('EB_TOP') . '    ';?><input type="number" name="default_certificate_bg_top" class="form-control input-small d-inline-block" value="<?php echo (int) $config->default_certificate_bg_top; ?>" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
	...
	<div class="controls">
		<?php echo Text::_('EB_WIDTH') . ' (mm)   ';?><input type="number" name="default_certificate_bg_width" class="form-control input-small d-inline-block" value="<?php echo (int) $config->get('default_certificate_bg_width', 210); ?>" />
		<?php echo Text::_('EB_HEIGHT') . ' (mm)   ';?><input type="number" name="default_certificate_bg_height" class="form-control input-small d-inline-block" value="<?php echo (int) $config->get('default_certificate_bg_height', 297); ?>" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
