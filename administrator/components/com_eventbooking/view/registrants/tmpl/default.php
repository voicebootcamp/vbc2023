...
Factory::getDocument()->addScript($rootUri . '/media/com_eventbooking/js/admin-registrants-default.min.js');
	...
	<div id="j-main-container"<?php if ($isJoomla4) echo ' class="eb-joomla4-container"'; ?>>
		...
		<table class="adminlist table table-striped">
			...
			<tr>
				...
				?>
                    <th class="center">
		                <?php echo HTMLHelper::_('grid.sort', Text::_('EB_LANGUAGE'), 'tbl.language', $this->state->filter_order_Dir, $this->state->filter_order); ?>
                    </th>
                <?php
				}
