...
class booking_screen_gadController extends JControllerForm
{
...
//		}
		...
		$this->registerTask( 'show_validation', 'show_validation' );
...
//		}
	...
	function process_booking_request(){
		$booking_screen = "booking_screen_gad";
	...
	function show_confirmation()
	{
		$jinput = JFactory::getApplication()->input;
		$frompage = $jinput->getString( 'frompage', '' );
		$jinput->set( 'view', 'gad_confirmation' );
	...
	function pp_return(){
		$jinput = JFactory::getApplication()->input;
		$frompage = $jinput->getString( 'frompage', '' );
		$jinput->set( 'view', 'gad_paypal_return' );
		$jinput->set( 'frompage', $frompage);
		$jinput->set( 'Itemid', $jinput->getString( 'Itemid'));
		$jinput->set( 'req_id', $jinput->getString( 'req_id'));
	...
	function authnet_return(){
		$jinput = JFactory::getApplication()->input;
		$frompage = $jinput->getString( 'frompage', '' );
		$jinput->set( 'view', 'gad_authnet_return' );
		$jinput->set( 'frompage', $frompage);
		$jinput->set( 'Itemid', $jinput->getString( 'Itemid'));
		$jinput->set( 'req_id', $jinput->getString( 'req_id'));
	...
	function twoco_return(){
		$jinput = JFactory::getApplication()->input;
		$frompage = $jinput->getString( 'frompage', '' );
		$jinput->set( 'view', 'gad_2co_return' );
		$jinput->set( 'frompage', $frompage);
		$jinput->set( 'Itemid', $jinput->getString( 'Itemid'));
		$jinput->set( 'req_id', $jinput->getString( 'req_id'));
