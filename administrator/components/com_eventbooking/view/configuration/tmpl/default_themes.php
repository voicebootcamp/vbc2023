	...
	<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="number" name="number_categories" class="form-control" value="<?php echo $config->number_categories; ?>" size="10" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="number" name="number_speakers_per_row" class="form-control input-small" value="<?php echo $config->get('number_speakers_per_row', 4); ?>" size="10" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
				...
				<div class="controls">
					<input type="number" name="number_sponsors_per_row" class="form-control input-small" value="<?php echo $config->get('number_sponsors_per_row', 4); ?>" size="10" />
				</div>
			</div>
		</fieldset>
	</div>
	...
	<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="number" name="number_events" class="form-control" value="<?php echo $config->number_events; ?>" size="10" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(array('multiple_booking' => '1')); ?>'>
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('link_to_event_details_from_cart', Text::_('EB_LINK_TO_EVENT_DETAILS_FROM_CART'), Text::_('EB_LINK_TO_EVENT_DETAILS_FROM_CART_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('link_to_event_details_from_cart', $config->get('link_to_event_details_from_cart', 1)); ?>
				</div>
			</div>
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(array('multiple_booking' => '1')); ?>'>
				<div class="control-label">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('show_event_end_date', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_EVENT_END_DATE'))); ?>
				</div>
				<div class="controls">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('show_cut_off_date', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_CUT_OFF_DATE'))); ?>
				</div>
				<div class="controls">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('show_registration_start_date', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_REGISTRATION_START_DATE'))); ?>
				</div>
				<div class="controls">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('show_cancel_before_date', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_CANCEL_BEFORE_DATE'))); ?>
				</div>
				<div class="controls">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('show_capacity', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_EVENT_CAPACITY'))); ?>
				</div>
				<div class="controls">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('show_group_rates', Text::_('EB_SHOW_GROUP_RATES')); ?>
				</div>
				<div class="controls">
		...
		<fieldset class="form-horizontal options-form">
            ...
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('public_registrants_list_show_num', Text::_('EB_SHOW_NUM')); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('public_registrants_list_show_num', $config->get('public_registrants_list_show_num', 1)); ?>
                </div>
            </div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('public_registrants_list_show_register_date', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_REGISTRATION_DATE'))); ?>
				</div>
				<div class="controls">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('public_registrants_list_show_ticket_types', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_TICKET_TYPES'))); ?>
				</div>
				<div class="controls">
            ...
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('public_registrants_list_show_number_registrants', Text::_('EB_SHOW_NUMBER_REGISTRANTS')); ?>
                </div>
                <div class="controls">
					<?php echo $this->lists['public_registrants_list_show_number_registrants']; ?>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('public_registrants_list_show_registration_status', Text::_('EB_SHOW_REGISTRATION_STATUS')); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('public_registrants_list_show_registration_status', $config->get('public_registrants_list_show_registration_status', 0)); ?>
                </div>
            </div>
		</fieldset>
		<fieldset class="form-horizontal options-form">
            ...
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('history_show_registration_date', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_REGISTRATION_DATE'))); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('history_show_registration_date', $config->get('history_show_registration_date', 1)); ?>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('history_show_registration_status', Text::_('EB_SHOW_REGISTRATION_STATUS')); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('history_show_registration_status', $config->get('history_show_registration_status', 1)); ?>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('history_show_transaction_id', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_TRANSACTION_ID'))); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('history_show_transaction_id', $config->get('history_show_transaction_id', 0)); ?>
                </div>
            </div>
		</fieldset>
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('rm_show_last_name', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_LAST_NAME'))); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('rm_show_last_name', $config->get('rm_show_last_name', 1)); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('rm_show_email', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_EMAIL'))); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('rm_show_email', $config->get('rm_show_email', 1)); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('rm_show_registration_date', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_REGISTRATION_DATE'))); ?>
				</div>
				<div class="controls">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('rm_show_payment_method', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_PAYMENT_METHOD'))); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('rm_show_payment_method', $config->get('rm_show_payment_method', 1)); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('rm_show_invoice', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_INVOICE_NUMBER'))); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('rm_show_invoice', $config->get('rm_show_invoice', 1)); ?>
				</div>
			</div>
            <div class="control-group">
                <div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('rm_show_transaction_id', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_TRANSACTION_ID'))); ?>
                </div>
                <div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('rm_show_transaction_id', $config->get('rm_show_transaction_id', 0)); ?>
                </div>
            </div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('rm_show_id', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_ID'))); ?>
				</div>
				<div class="controls">
