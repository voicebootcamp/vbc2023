...
?>
<form action="index.php?option=com_eventbooking&view=message" method="post" name="adminForm" id="adminForm" class="form-horizontal eb-configuration<?php if (!EventbookingHelper::isJoomla4()) echo ' joomla3'; ?>">
