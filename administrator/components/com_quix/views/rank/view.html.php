 ...
 * @since  1.6
 */
class QuixViewRank extends JViewLegacy
{
	...
	{
		JToolBarHelper::title(JText::_('COM_QUIX_TITLE_QUIXRANK'), 'home');
		...
		JHtmlSidebar::setAction('index.php?option=com_quix&view=rank');
