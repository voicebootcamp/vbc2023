...
defined('_JEXEC') or die('Restricted access');
	...
	if($user->guest){
		...
		try{
			...
			logIt($e->getMessage(), "be_seat_over_detail_tmpl_default", "", "");
...
<table width="100%"  >
    <tr>
      <td align="left" colspan="2"> <h3><?php echo JText::_('RS1_ADMIN_SCRN_TITLE')." - ".JText::_('RS1_ADMIN_SCRN_TAB_SEAT_ADJUSTMENTS');?></h3></td>
    </tr>
   <tr>
...
<table border="0" cellpadding="4" cellspacing="0" class="table table-striped">
    ...
    <tr>
      ...
      <td colspan="2"><?php echo $this->detail->id_seat_adjustments ?></td>
    </tr>
	<tr>
	...
	<tr>
	  <td><?php echo JText::_('RS1_ADMIN_SEAT_ADJUSTMENT');?></td>
