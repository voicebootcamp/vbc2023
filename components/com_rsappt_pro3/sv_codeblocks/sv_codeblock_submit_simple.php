  ...
  <table align="center">
    ...
    <tr class="submit_section">
      ...
      <div id="calcResults" style="visibility:hidden; display:none; height:auto">
        <table style="border:1px solid black; width:300px; margin:auto" class="calcResults_outside" cellpadding="4px">
          <tr class="calcResults_header">
            <td style="border-bottom:solid 1px; border-right:solid 1px; text-align:center"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_RES_RATE');?></label></td>
            ...
            <td style="border-bottom:solid 1px; border-right:solid 1px; text-align:center"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_RES_RATE_TOTAL');?></label></td>
          </tr>
          <tr style="text-align:right">
            <td style="border-bottom:solid 1px; border-right:solid 1px; height:auto;"><div style="float:right">
            <div style="display: table-cell; padding-left:0px;"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?></label></div>
      ...
      <?php if ($extras_row_count->count > 0 ){?>
          <tr>
            ...
            <td style="border-bottom:solid 1px; border-right:solid 1px; text-align:right"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_EXTRAS_FEE');?></label></td>
      ...
      <?php if ($apptpro_config->additional_fee != 0.00 ){?>
          <tr>
            <td style="border-bottom:solid 1px;">&nbsp;            </td>
            <td style="border-bottom:solid 1px; border-right:solid 1px; text-align:right"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_RES_ADDITIONAL_FEE');?></label></td>
      ...
      <?php if($apptpro_config->enable_coupons == "Yes" || $apptpro_config->enable_eb_discount == "Yes"){ ?>
          <tr>
            <td style="border-bottom:solid 1px;">&nbsp;            </td>
            <td style="border-bottom:solid 1px; border-right:solid 1px; text-align:right"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_DISCOUNT');?></label></td>
      ...
      <?php if($apptpro_config->enable_gift_cert == "Yes"){ ?>
          <tr style="text-align:right" id="gc_row">
            <td style="border-bottom:solid 1px;">&nbsp;            </td>
            <td style="border-bottom:solid 1px; border-right:solid 1px; text-align:right"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_GC_CREDIT');?></label></td>
      ...
      <?php if($user_credit != NULL){ ?>
          <tr style="text-align:right">
            <td style="border-bottom:solid 1px;">&nbsp;            </td>
            <td style="border-bottom:solid 1px; border-right:solid 1px; text-align:right"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_USER_CREDIT');?></label></td>
	  ...
	  <?php } ?>
          <tr style="text-align:right">
            ...
            <td style="border-bottom:solid 1px; border-right:solid 1px; text-align:right"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_RES_RATE_TOTAL');?></label></td>
            <td style="border-bottom:solid 1px; border-right:solid 1px;"><div style="display: table-cell; padding-left:5px; float:right">
			<div style="display: table-cell; padding-left:5px;"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?></label></div>
          ...
          <tr style="text-align:right" id="deposit_only">
            <td style="border-bottom:solid 1px;">&nbsp;            </td>
            <td style="border-bottom:solid 1px; border-right:solid 1px; text-align:right"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_DEPOSIT');?></label></td>
            <td style="border-bottom:solid 1px; border-right:solid 1px;"><div style="float:right"><div style="display: table-cell; padding-left:0px;"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?></label></div>
...
<?php if($apptpro_config->enable_coupons == "Yes"){ ?>
 ...
 <?php if($apptpro_config->enable_gift_cert == "Yes"){ ?>
     <tr class="submit_section" style="border-top:solid 1px">
        <td colspan="3"><label class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_GIFT_CERT');?></label>
...
<!--	    <tr class="submit_section">
	      <td colspan="4">
	    	<div id="dynamic_recaptcha_1" align="center" class="sv_recaptcha"></div>
...
-->	<?php // } ?>
    <tr class="submit_section">
      <td></td>
      <td colspan="3"><div id="errors" class="sv_apptpro_errors"><label class="sv_apptpro_errors"><?php echo $err ?></label></div></td>
	</tr>
