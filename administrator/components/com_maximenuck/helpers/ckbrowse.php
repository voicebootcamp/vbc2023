...
class CKBrowse {
	...
	public static function getItemsList($type = 'image') {
		...
		$folder = $input->get('folder', '', 'string') ? '/' . trim($input->get('folder', '', 'string'), '/') : '/' . trim(JComponentHelper::getParams('com_maximenuck')->get('imagespath', 'images'), '/');
		...
		// no folder filtering 
//		if (JComponentHelper::getParams('com_maximenuck')->get('imagespathexclusive', '0') == '0') {
...
//		}
	...
	public static function ajaxAddPicture() {
		...
		$imgpath = $input->get('path', '', 'string') ? '/' . trim($input->get('path', '', 'string'), '/') . '/' : '/' . trim(JComponentHelper::getParams('com_maximenuck')->get('imagespath', 'images'), '/') . '/';
