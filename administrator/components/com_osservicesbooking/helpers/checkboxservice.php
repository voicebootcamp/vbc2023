...
class ServiceCheckbox
{
	 ...
	 */
	static function checkingBreaktime($sid,$eid)
	{
		global $mapClass;
		$db = JFactory::getDbo();
		$serviceids = array();
		...
		foreach ($services as $service) 
		{
			...
			$db->setQuery("Select id as value, concat(venue_name, ' - ' , address) as text from #__app_sch_venues where published = '1' and id in (Select vid from #__app_sch_venue_services where sid = '$service->id') order by address");
			...
			if(count($venues) > 0)
			{
				...
				$venue 		.= JHTML::_('select.genericlist',$venueArr,'vid_'.$service->id,'class="input-large form-select ilarge"','value','text',$vid);
			}
										 ...
										 for($i1=0;$i1<count($breaks);$i1++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			...
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$i1.'_1','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_from);
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$i1.'_1','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_to);
													?>
										 		</td>
										 	</tr>
										 	<?php
									 	 ...
									 	 for($j=$i1;$j<4;$j++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$j.'_1','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$j.'_1','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 	</tr>
										 	<?php
										 ...
										 for($i1=0;$i1<count($breaks);$i1++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$i1.'_2','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_from);
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$i1.'_2','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_to);
													?>
										 		</td>
										 	</tr>
										 	<?php
									 	 ...
									 	 for($j=$i1;$j<4;$j++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$j.'_2','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$j.'_2','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 	</tr>
										 	<?php
										 ...
										 for($i1=0;$i1<count($breaks);$i1++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$i1.'_3','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_from);
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$i1.'_3','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_to);
													?>
										 		</td>
										 	</tr>
										 	<?php
									 	 ...
									 	 for($j=$i1;$j<4;$j++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$j.'_3','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$j.'_3','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 	</tr>
										 	<?php
										 ...
										 for($i1=0;$i1<count($breaks);$i1++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$i1.'_4','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_from);
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$i1.'_4','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_to);
													?>
										 		</td>
										 	</tr>
										 	<?php
									 	 ...
									 	 for($j=$i1;$j<4;$j++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$j.'_4','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$j.'_4','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 	</tr>
										 	<?php
										 ...
										 for($i1=0;$i1<count($breaks);$i1++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$i1.'_5','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_from);
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$i1.'_5','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_to);
													?>
										 		</td>
										 	</tr>
										 	<?php
									 	 ...
									 	 for($j=$i1;$j<4;$j++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$j.'_5','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$j.'_5','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 	</tr>
										 	<?php
										 ...
										 for($i1=0;$i1<count($breaks);$i1++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$i1.'_6','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_from);
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$i1.'_6','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_to);
													?>
										 		</td>
										 	</tr>
										 	<?php
									 	 ...
									 	 for($j=$i1;$j<4;$j++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$j.'_6','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$j.'_6','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 	</tr>
										 	<?php
										 ...
										 for($i1=0;$i1<count($breaks);$i1++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$i1.'_7','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_from);
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$i1.'_7','class="'.$mapClass['input-small'].' form-select"','value','text',$break->break_to);
													?>
										 		</td>
										 	</tr>
										 	<?php
									 	 ...
									 	 for($j=$i1;$j<4;$j++){
										 	...
										 	<tr>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_START');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'start_from'.$service->id.$j.'_7','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 		<td width="50%" align="left">
										 			<?php echo JText::_('OS_END');?>:
										 			<?php
													echo JHTML::_('select.genericlist',$lists['hours'],'end_to'.$service->id.$j.'_7','class="'.$mapClass['input-small'].' form-select"','value','text');
													?>
										 		</td>
										 	</tr>
										 	<?php
			...
			$html .= '<div style="padding:5px;"><table  width="100%"><tr><td width="2%"><input type="checkbox" name="service_id[]" id="service_id_'.$service->id.'" value="'.$service->id.'" '.$checked.'></td><td width="15%"><B>'.$service->service_name.'</B> </td><td width="30%">'.$venue.'</td><td width="30%">'.JText::_('OS_ADDITIONAL_COST').': <input type="text" size="4" class="input-mini form-control" value="'.$additional_cost.'" name="add_'.$service->id.'"></td></tr>'.$working_time.$body.'</table></div>';
		}
...
class HelperDateTime{
	 ...
	 *
	 */
	static function CreatDropHour($name = 'default',$select=null,$attribute='null'){
		$option = array();
		for ($i=0; $i<=24; $i++){
	...
	static function CreatDropMinuste($name='default',$select=null,$attribute=null){
		$option = array();
		for ($i=0; $i<60; $i+=5){
			$option[] = JHtml::_('select.option',$i,($i<10)? "0$i":$i);
		}
...
class Helpermenu{
	...
	static function creatmenu($option, $task,$subMenus = array()){
