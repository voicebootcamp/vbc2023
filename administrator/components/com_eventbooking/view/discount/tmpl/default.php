...
<form action="index.php?option=com_eventbooking&view=discount" method="post" name="adminForm" id="adminForm" class="form form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input class="input-medium form-control" type="number" name="discount_amount" id="discount_amount" size="10" maxlength="250"
	...
	<?php
		...
		?>
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-medium form-control" type="number" name="number_events" id="number_events" size="10" maxlength="250"
