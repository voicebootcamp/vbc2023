    	...
    	<table width="95%" border="0" cellspacing="0" cellpadding="0">
        	...
        	<tr>
		        <td align="center">
                  ...
                  <input type="button" name="btnRemoveCategoryScope" id="btnRemoveCategoryScope" size="10"  onclick="doRemoveCategoryScope()" value="<?php echo JText::_('RS1_ADMIN_SCRN_GROUP_REMOVE_MOBILE');?>" />
                </td>
			<tr>
