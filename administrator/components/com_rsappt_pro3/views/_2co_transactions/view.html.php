...
class _2co_transactionsView_2co_transactions extends JViewLegacy
{
	/**
	 * Custom Constructor
	 */
	function __construct( $config = array())
	{
	  ...
	  **/	  
 	 ...
 	 global $context;
	 $context = '_2co_transactions.list.';
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - 2CheckOut.com Transactions') );
   
   
   		//DEVNOTE: Set ToolBar title
	    JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_2CO_LIST' ), '_2co' );
    
    	//DEVNOTE: Set toolbar items for the page
		JToolBarHelper::deleteList( JText::_('RS1_ADMIN_TOOLBAR_2CO_DEL_CONF'), 'remove', JText::_('RS1_ADMIN_TOOLBAR_2CO_DEL') );
		JToolBarHelper::editList('edit', JText::_('RS1_ADMIN_TOOLBAR_2CO_VIEW'));
		JToolBarHelper::custom('export__2co', 'save', '', JText::_('RS1_ADMIN_TOOLBAR_2CO_EXPORT'));
		JToolBarHelper::cancel('cancel', JText::_('RS1_ADMIN_SCRN_BTN_CLOSE'));
		JToolBarHelper::help('screen.rsappt_pro._2co', true);
