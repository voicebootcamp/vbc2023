...
trait EventbookingViewEvent
{
	...
	public function buildFormData($item, $categories, $locations)
	{
		...
		{
			$this->lists['deposit_type'] = HTMLHelper::_('select.genericlist', $options, 'deposit_type', ' class="input-small form-select" ', 'value', 'text', $item->deposit_type);
		}
		...
		{
			$selectedHour   = $this->input->post->getInt('event_date_hour', 0);
			$selectedMinute = $this->input->post->getInt('event_date_minute', 0);
		}
		...
		$this->lists['event_date_minute'] = HTMLHelper::_('select.integerlist', 0, 55, 5, 'event_date_minute', ' class="input-mini form-select w-auto d-inline-block" ', (int) $selectedMinute, '%02d');
		...
		{
			$selectedHour   = $this->input->post->getInt('event_end_date_hour', 0);
			$selectedMinute = $this->input->post->getInt('event_end_date_minute', 0);
		}
		...
		$this->lists['event_end_date_minute'] = HTMLHelper::_('select.integerlist', 0, 55, 5, 'event_end_date_minute', ' class="input-mini form-select w-auto d-inline-block" ', (int) $selectedMinute, '%02d');
		...
		$this->lists['cut_off_minute'] = HTMLHelper::_('select.integerlist', 0, 55, 5, 'cut_off_minute', ' class="input-mini form-select w-auto d-inline-block" ', (int) $selectedMinute, '%02d');
		...
		$this->lists['registration_start_minute'] = HTMLHelper::_('select.integerlist', 0, 55, 5, 'registration_start_minute', ' class="form-select input-mini form-select w-auto d-inline-block" ', (int) $selectedMinute, '%02d');
		...
		$this->lists['user_registration'] = HTMLHelper::_('select.genericlist', $options, 'user_registration',
			'class="form-select"', 'value', 'text', $params->get('user_registration', ''));
		...
		$this->lists['third_reminder_frequency']  = HTMLHelper::_('select.genericlist', $options, 'third_reminder_frequency', 'class="form-select d-inline-block w-auto"', 'value', 'text', $item->third_reminder_frequency ?: 'd');
