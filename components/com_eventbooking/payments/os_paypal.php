...
class os_paypal extends RADPayment
{
	...
	public function processPayment($row, $data)
	{
		...
		$this->setParameter('cancel_return',
			$siteUrl . 'index.php?option=com_eventbooking&view=cancel&layout=default&id=' . $row->id . '&Itemid=' . $Itemid);
	...
	public function refund($row)
	{
		...
		{
			Factory::getApplication()->enqueueMessage('You need to enter API parameters in Advanced tab of the payment plugin to be able to refund',
				'error');
