...
class requestsViewrequests_thankyou extends JViewLegacy
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - send thank you') );
		...
		JToolBarHelper::cancel( 'cancel_thankyou', 'Close' );
