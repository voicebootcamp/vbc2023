 ...
 */
class seat_adjustments_detailViewseat_adjustments_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - seat_adjustments') );
		...
		JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_SEAT_ADJUSTMENTS' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit'  );
		JToolBarHelper::save();
		if ($isNew)  {
		...
		JToolBarHelper::divider();
		JToolBarHelper::help( 'screen.rsappt_pro.seat_adjustments_edit', true );    
