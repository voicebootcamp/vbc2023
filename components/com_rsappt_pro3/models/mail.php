...
class mailModelmail extends JModelLegacy
{
	...
	/**
	 * Method to get a mail data
	 *
	 * this method is called from the owner VIEW by VIEW->get('Data');
	 * - get list of all mail for the current data page.
	...
	function _buildQuery()
	{
		...
		$query = ' SELECT * FROM '.$this->_table_prefix.'mail'.$orderby;
		//echo $query;
		//exit;
