...
<h1 class="eb-page-heading">
	<?php echo $this->params->get('page_heading') ?: $this->escape(Text::_('EB_LOCATIONS_MANAGEMENT')); ?>
	<span class="add_location_link" style="float: right; font-size:14px;"><a
			href="<?php echo Route::_('index.php?option=com_eventbooking&view=location&layout=form&Itemid=' . $this->Itemid); ?>"><i class="icon-plus"></i><?php echo Text::_('EB_SUBMIT_LOCATION'); ?></a></span>
</h1>
<?php
if (EventbookingHelper::isValidMessage($this->params->get('intro_text')))
{
?>
	<div class="eb-description eb-locations-management-intro-text"><?php echo $this->params->get('intro_text');?></div>
<?php
}
?>
