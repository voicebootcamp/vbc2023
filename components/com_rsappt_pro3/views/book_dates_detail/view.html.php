 ...
 */
class admin_detailViewbook_dates_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		//$document->setTitle( JText::_('Appointment Booking Pro - book_dates') );
		...
		$this->assignRef('filter_book_dates_resource',	$filter_book_dates_resource);
