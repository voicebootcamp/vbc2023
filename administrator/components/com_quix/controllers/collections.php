 ...
 * @since  1.6
 */
class QuixControllerCollections extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'collection', $prefix = 'QuixModel', $config = array())
	{
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_quix&view=collections');
	}
}
