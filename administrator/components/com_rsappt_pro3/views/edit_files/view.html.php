...
class edit_filesViewedit_files extends JViewLegacy
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - edit files') );
   
   
   		//DEVNOTE: Set ToolBar title
	    JToolBarHelper::title( 'Appointment Booking Pro - '.JText::_('RS1_ADMIN_TOOLBAR_EDIT_FILES'), 'editfiles.png' );
		...
		JToolBarHelper::divider();
		JToolBarHelper::help('ABPRO2_HELP_CSS_EDIT', true);
