      ...
      <div class="qx-admin-box pro-activation">
        <div class="display-table">
          <div class="table-cell table-content">
            <img
                    alt="quix-logo"
                    src="<?php echo Uri::root(); ?>media/quixnxt/images/quix-logo.png" width="60px">
          </div>
          <div class="table-cell table-content">
          ...
          <div class="table-cell">
            <a
                    href="<?php echo Uri::base(); ?>index.php?option=com_quix&view=config"
