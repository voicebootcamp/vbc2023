...
class errorlog_detailController extends JControllerForm
{
	...
	*/
	function edit($key=null, $urlVar=null)
	{
		...
		$jinput->set( 'view', 'errorlog_detail' );
		...
		// Checkin the errorlog
		$model = $this->getModel('errorlog_detail');
		$model->checkout();
	}
	...
	*/
	function save($key=null, $urlVar=null)
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=errorlog',$msg );
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=errorlog' );
		}
	}
