...
<table width="100%" >
    <tr>
      <td align="left" colspan="2"> <h3><?php echo JText::_('RS1_ADMIN_SCRN_TITLE').JText::_('RS1_ADMIN_SCRN_RESOURCE_BOOK_DATES_TITLE');?></h3></td>
    </tr>
</table>
<table border="0" cellpadding="4" cellspacing="0">
   <tr>
    ...
    <tr>
      <td colspan="3">
        <?php echo JText::_('RS1_ADMIN_SCRN_BOOK_DATE_DETAIL_INTRO');?></td>
    </tr>
    <tr class="admin_detail_row1">
      <td width="15%"><?php echo JText::_('RS1_ADMIN_SCRN_BOOK_DATE_DETAIL_ID');?></td>
      <td colspan="2"><?php echo $this->detail->id_book_dates ?></td>
    </tr>
    <tr class="admin_detail_row0">
      <td><?php echo JText::_('RS1_ADMIN_SCRN_BD_RESOURCE');?></td>
      <td colspan="2">
    ...
    <tr class="admin_detail_row0">
      <td><?php echo JText::_('RS1_ADMIN_SCRN_BD_DATE');?></td>
      <td>
    ...
    <tr class="admin_detail_row1">
        <td ><?php echo JText::_('RS1_ADMIN_SCRN_BOOK_DATE_DETAIL_PUBLISHED');?></td>
        <td colspan="2">
