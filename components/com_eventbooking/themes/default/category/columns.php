...
<div id="eb-category-page-columns" class="eb-container">
	...
	if (count($this->items))
	{
		// This is for backward compatible purpose, in case old layout was overridden
	...
	<form method="post" name="adminForm" id="adminForm" action="<?php echo Route::_('index.php?option=com_eventbooking&view=category&layout=columns&id=' . $this->categoryId . '&Itemid=' . $this->Itemid); ?>">
