...
class categories_detailController extends JControllerForm
{
	...
	*/
	function edit($key=null, $urlVar=null)
	{
		...
		$jinput->set( 'view', 'categories_detail' );
		...
		// Checkin the categories
		$model = $this->getModel('categories_detail');
		$model->checkout();
	}
	...
	*/
	function save($key=null, $urlVar=null)
	{
		...
		$model->checkin();
		if($key=="2new"){
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=categories_detail&task=edit&cid[]=-1',$msg );
		} else {
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=categories_abp',$msg );
		}
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro3&controller=categories_abp' );
		}
	}
	...
	*/
	...
	/** function saveorder
	*
	* saveorder of the categories items
	* 			
	* @param array cid		- array of id
