...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('waitinglist_form_message', $this->message->waitinglist_form_message, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
	...
	<div class="controls">
		<?php echo $editor->display('waitinglist_complete_message', $this->message->waitinglist_complete_message, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('watinglist_confirmation_body', $this->message->watinglist_confirmation_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('watinglist_notification_body', $this->message->watinglist_notification_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('registrant_waitinglist_notification_body', $this->message->registrant_waitinglist_notification_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('request_payment_email_body', $this->message->request_payment_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('request_payment_email_body_pdr', $this->message->request_payment_email_body_pdr, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
	...
	<div class="controls">
		<?php echo $editor->display('registration_payment_form_message', $this->message->registration_payment_form_message, '100%', '350', '75', '8') ;?>
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('waiting_list_cancel_confirmation_message', $this->message->waiting_list_cancel_confirmation_message, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
	...
	<div class="controls">
		<?php echo $editor->display('waiting_list_cancel_complete_message', $this->message->waiting_list_cancel_complete_message, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('waiting_list_cancel_confirmation_email_body', $this->message->waiting_list_cancel_confirmation_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('waiting_list_cancel_notification_email_body', $this->message->waiting_list_cancel_notification_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>