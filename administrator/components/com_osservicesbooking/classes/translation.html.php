			...
			<table  width="100%">
				<tr>
					<td width="40%" style="text-align: left;">
						<div class="btn-group">
							<input type="text" name="search" id="search" value="<?php echo $jinput->get('search','','string');?>" class="text_area search-query form-control" onchange="document.adminForm.submit();" />
							<button onclick="this.form.submit();" class="btn btn-primary"><?php echo JText::_( 'Go' ); ?></button>
							<button onclick="document.getElementById('search').value='';this.form.submit();" class="btn btn-secondary"><?php echo JText::_( 'Reset' ); ?></button>
						</div<
					</td>
