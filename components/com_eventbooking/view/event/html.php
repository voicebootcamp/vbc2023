...
class EventbookingViewEventHtml extends RADViewHtml
{
	 ...
	 * @var array
	 */
	protected $paramsViews = ['categories', 'category', 'upcomingevents', 'calendar', 'fullcalendar', 'location', 'event'];
	...
	public function display()
	{
		...
		$this->url               = Route::_(EventbookingHelperRoute::getEventRoute($item->id, $item->main_category_id, $this->Itemid), false, 0, true);
