...
?>
<form action="index.php?option=com_eventbooking&view=mitem" method="post" name="adminForm" id="adminForm" class="form form-horizontal<?php if (!EventbookingHelper::isJoomla4()) echo ' joomla3'; ?>">
	<?php
	if ($translatable)
	{
		echo HTMLHelper::_($tabApiPrefix . 'startTabSet', 'mitem', array('active' => 'general-page'));
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'mitem', 'general-page', Text::_('EB_GENERAL', true));
	}
	?>
