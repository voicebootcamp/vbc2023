...
class stripe_transactionsViewstripe_transactions extends JViewLegacy
{
	/**
	 * Custom Constructor
	 */
	function __construct( $config = array())
	{
	  ...
	  **/	  
 	 ...
 	 global $context;
	 $context = 'stripe_transactions.list.';
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - stripe_transactions') );
   
   
   		//DEVNOTE: Set ToolBar title
	    JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_STRIPE_LIST' ), 'stripe' );
    
    	//DEVNOTE: Set toolbar items for the page
		JToolBarHelper::deleteList( JText::_('RS1_ADMIN_TOOLBAR_STRIPE_DEL_CONF'), 'remove', JText::_('RS1_ADMIN_TOOLBAR_STRIPE_DEL') );
		JToolBarHelper::editList('edit', JText::_('RS1_ADMIN_TOOLBAR_STRIPE_VIEW'));
		JToolBarHelper::divider();
		JToolBarHelper::custom('export_stripe', 'save', '', JText::_('RS1_ADMIN_TOOLBAR_STRIPE_EXPORT'));
		JToolBarHelper::divider();
