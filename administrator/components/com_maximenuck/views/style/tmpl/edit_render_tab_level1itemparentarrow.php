...
<div class="ckrow">
	...
	<input type="text" id="level1itemactivestylesparentarrowcolor" name="level1itemactivestylesparentarrowcolor" class="level1itemactivestyles cktip <?php echo $this->colorpicker_class; ?>" title="<?php echo JText::_('CK_PARENTARROWACTIVECOLOR_DESC'); ?>" />
	<img class="ckicon" src="<?php echo $this->imagespath ?>/color.png" />
	<span><?php echo JText::_('CK_ACTIVE_HOVER'); ?></span>
	<input type="text" id="level1itemactivehoverstylesparentarrowcolor" name="level1itemactivehoverstylesparentarrowcolor" class="level1itemactivehoverstyles cktip <?php echo $this->colorpicker_class; ?>" title="<?php echo JText::_('CK_PARENTARROWACTIVECOLOR_DESC'); ?>" />
</div>
...
<div class="ckrow">
	...
	<div class="ckbutton-group">
		...
		<a class="ckbutton" onclick="ckCallImageManagerPopup('level1itemnormalstylesparentitemimage')" href="javascript:void(0)" ><?php echo JText::_('CK_SELECT'); ?></a>
