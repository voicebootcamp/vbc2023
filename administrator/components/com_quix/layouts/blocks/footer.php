...
?>
<footer id="footer" class="qx-padding qx-text-center">
  <p>
    <a href="https://www.themexpert.com/quix-pagebuilder" target="_blank" class="qx-margin-right">
      Quix - Joomla Page Builder
    </a>
    <label class="qx-margin-small-right qx-label qx-label-<?php echo($pro ? 'success' : 'warning'); ?>"><?php echo($pro ? 'PRO' : 'FREE'); ?></label>
    <label class="qx-label"><?php echo $version; ?></label>
  </p>
  <ul class="qx-icon-link qx-iconnav qx-flex-center">
    <li>
      <a href="https://www.themexpert.com/docs/quix-builder" target="_blank" class="qx-margin-small-right qx-icon-link qx-icon">
    ...
    <li>
      <a href="https://www.themexpert.com/support" target="_blank" class="qx-margin-small-right qx-icon-link qx-icon">
        <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <li>
      <a href="https://www.fb.com/groups/QuixUserGroup" target="_blank" class="qx-margin-small-right qx-icon-link qx-icon">
        <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <li>
      <a href="http://extensions.joomla.org/write-review/review/add?extension_id=11775" target="_blank" class="qx-margin-small-right qx-icon-link qx-icon">
        <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
  ...
  <p class="qx-margin-small">
    Made with <span style="color: #e25555;">&#9829;</span> by <a href="https://www.themexpert.com">ThemeXpert</a>
  </p>
</footer>
