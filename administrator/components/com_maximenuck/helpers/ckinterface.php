...
class CKInterface extends \stdClass {
	...
	<div class="ckrow">
		...
		<div class="ckbutton-group">
			<input class="" type="radio" value="repeat" id="<?php echo $prefix; ?>backgroundimagerepeatrepeat" name="<?php echo $prefix; ?>backgroundimagerepeat" class="<?php echo $prefix; ?>" />
			<label class="ckbutton first" for="<?php echo $prefix; ?>backgroundimagerepeatrepeat"><img class="ckicon" src="<?php echo $this->imagespath ?>/bg_repeat.png" />
	...
	public function createMenuText($prefix) { 
	?>
	<div class="ckrow">
		<label for="<?php echo $prefix; ?>textgfont"><?php echo CKText::_('CK_FONTSTYLE_LABEL'); ?></label>
		<img class="ckicon" src="<?php echo $this->imagespath ?>/font_add.png" />
	...
	<div class="ckrow">
		<label for="level1itemnormalstylesfontsize"><?php echo CKText::_('CK_TITLEFONTSTYLES_LABEL'); ?></label>
		<img class="ckicon" src="<?php echo $this->imagespath ?>/style.png" />
		<input type="text" id="level1itemnormalstylesfontsize" name="level1itemnormalstylesfontsize" class="level1itemnormalstyles cktip" style="width:45px;" title="<?php echo CKText::_('CK_FONTSIZE_DESC'); ?>" />
		<img class="ckicon" src="<?php echo $this->imagespath ?>/color.png" />
		<span><?php echo CKText::_('CK_NORMAL'); ?></span>
		<input type="text" id="level1itemnormalstylesfontcolor" name="level1itemnormalstylesfontcolor" class="level1itemnormalstyles cktip <?php echo $this->colorpicker_class; ?>" title="<?php echo CKText::_('CK_FONTCOLOR_DESC'); ?>" />

		<img class="ckicon" src="<?php echo $this->imagespath ?>/color.png" />
		<span><?php echo CKText::_('CK_HOVER'); ?></span>
		<input type="text" id="level1itemhoverstylesfontcolor" name="level1itemhoverstylesfontcolor" class="level1itemhoverstyles cktip <?php echo $this->colorpicker_class; ?>" title="<?php echo CKText::_('CK_FONTHOVERCOLOR_DESC'); ?>" />
	</div>
	<div class="ckrow">
		<label for="level1itemnormalstylesdescfontsize"><?php echo CKText::_('CK_DESCFONTSTYLES_LABEL'); ?></label>
		<img class="ckicon" src="<?php echo $this->imagespath ?>/style.png" />
		<input type="text" id="level1itemnormalstylesdescfontsize" name="level1itemnormalstylesdescfontsize" class="level1itemnormalstyles cktip" style="width:45px;" title="<?php echo CKText::_('CK_FONTSIZE_DESC'); ?>" />
		<img class="ckicon" src="<?php echo $this->imagespath ?>/color.png" />
		<span><?php echo CKText::_('CK_NORMAL'); ?></span>
		<input type="text" id="level1itemnormalstylesdescfontcolor" name="level1itemnormalstylesdescfontcolor" class="level1itemnormalstyles cktip <?php echo $this->colorpicker_class; ?>" title="<?php echo CKText::_('CK_FONTCOLOR_DESC'); ?>" />
		<img class="ckicon" src="<?php echo $this->imagespath ?>/color.png" />
		<span><?php echo CKText::_('CK_HOVER'); ?></span>
		<input type="text" id="level1itemhoverstylesdescfontcolor" name="level1itemhoverstylesdescfontcolor" class="level1itemhoverstyles cktip <?php echo $this->colorpicker_class; ?>" title="<?php echo CKText::_('CK_FONTHOVERCOLOR_DESC'); ?>" />
	</div>
	<?php
	}
