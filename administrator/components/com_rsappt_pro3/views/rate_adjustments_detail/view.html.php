 ...
 */
class rate_adjustments_detailViewrate_adjustments_detail extends JViewLegacy
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Appointment Booking Pro - rate_adjustments') );
		...
		JToolBarHelper::title( 'ABPro - '.JText::_( 'RS1_ADMIN_TOOLBAR_RATE_ADJUSTMENTS' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit'  );
		JToolBarHelper::save();
		if ($isNew)  {
		...
		JToolBarHelper::divider();
		JToolBarHelper::help( 'screen.rsappt_pro.rate_adjustments_edit', true );    
