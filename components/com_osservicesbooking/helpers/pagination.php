...
if (!class_exists('OSBJPagination')){
	class OSBJPagination extends JObject
	{
		...
		function _item_active(&$item)
		{
			...
			if($item->base>0)
			{
				return "<li class=' page-item ".$hiddenphone."'><a class='page-link' href=\"javascript: document.ftForm.limitstart.value=".$item->base."; document.ftForm.submit();\" onclick=\"javascript: document.ftForm.limitstart.value=".$item->base."; document.ftForm.submit();\" >".$item->text."</a></li>";
			}
			else
			{
				return "<li class=' page-item ".$hiddenphone."'><a class='page-link' href=\"javascript: document.ftForm.limitstart.value=".$item->base."; document.ftForm.submit();\" title=\"".$item->text."\" onclick=\"javascript: document.ftForm.limitstart.value=0; document.ftForm.submit();\" >".$item->text."</a></li>";
			}
		...
		function _item_inactive(&$item)
		{
			...
			if ($mainframe->isClient('administrator')) {
				...
				return "<li class='page-item active ".$hiddenphone."'><a class='page-link'>" . $item->text . "</a></li>";
			}
		}
