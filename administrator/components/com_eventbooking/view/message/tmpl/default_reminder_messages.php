...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('reminder_email_body', $this->message->reminder_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('second_reminder_email_body', $this->message->second_reminder_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
<div class="control-group">
    <div class="control-label">
    ...
    <div class="controls">
        <input type="text" name="third_reminder_email_subject" class="input-xlarge" value="<?php echo $this->message->third_reminder_email_subject; ?>" size="50" />
    </div>
</div>
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('third_reminder_email_body', Text::_('EB_THIRD_REMINDER_EMAIL_BODY')); ?>
        <p class="eb-available-tags">
			<?php echo Text::_('EB_AVAILABLE_TAGS'); ?>: <strong>[REGISTRATION_DETAIL], [EVENT_DATE], [FIRST_NAME], [LAST_NAME], [EVENT_TITLE]</strong>
        </p>
    </div>
    <div class="controls">
		<?php echo $editor->display('third_reminder_email_body', $this->message->third_reminder_email_body, '100%', '350', '75', '8') ;?>
    </div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $editor->display('offline_payment_reminder_email_body', $this->message->offline_payment_reminder_email_body, '100%', '350', '75', '8') ;?>
	</div>
</div>
